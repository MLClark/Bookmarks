...
(( 
 ...
 SELECT
  ...
  GROUP BY ppp.payscheduleperiodid, ppp.personid, pp.pspaypayrollid, pes.personearnsetuppid, st.paycode, st.rate, pc.paycodeshortdesc, ppp.paymenttype, (COALESCE(ppp.sequencenumber, '~'::character varying)), st.paycodeaffiliationid)  st1
...
GROUP BY st1.payscheduleperiodid, st1.personid, st1.paymentheaderid, st1.pspaypayrollid, st1.personearnsetuppid, st1.etv_id, st1.etvname, st1.paymenttype, st2."coalesce", st1.paycodeaffiliationid, st2.ytd_hrs, st2.ytd_amount, st2.ytd_wage
...
GROUP BY p21.personid, p21.payscheduleperiodid, p21.paymentheaderid, p21.pspaypayrollid, p21.personearnsetuppid, p21.etv_id, p21.etvname, p21.paymenttype, p21."coalesce", p22.ytd_hrs, p22.ytd_amount, p22.ytd_wage, p21.paycodeaffiliationid

ALTER TABLE payroll.cognos_proposedpayrollregisterearnings
  OWNER TO ehcmuser;
GRANT ALL ON TABLE payroll.cognos_proposedpayrollregisterearnings TO ehcmuser;
