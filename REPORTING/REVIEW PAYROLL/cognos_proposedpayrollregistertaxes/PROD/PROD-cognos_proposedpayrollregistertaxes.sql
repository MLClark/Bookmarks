...
--CREATE OR REPLACE VIEW payroll.cognos_proposedpayrollregistertaxes AS 
 SELECT ppp.payscheduleperiodid,
  ...
  GROUP BY ppp.payscheduleperiodid, ppp.personid, pp.pspaypayrollid, st.paycode, pc.paycodeshortdesc, pc.paycodetypeid, ppp.paymenttype, st.taxid, t.taxiddesc, pu.employertaxid, trp.taxider, pte.persontaxelectionpid, ppp.sequencenumber, st.amount_ytd, st.subject_wages_ytd, st.units_ytd
UNION
