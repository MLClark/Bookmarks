...
UNION
 SELECT p2.payscheduleperiodid,
  ...
  WHERE p2.personid = '92' and p2.payscheduleperiodid = 744
   and (p2.payscheduleperiodid IN ( SELECT pay_schedule_period.payscheduleperiodid
...
ALTER TABLE payroll.cognos_proposedpayrollregisterearnings
  OWNER TO skybotsu;
GRANT ALL ON TABLE payroll.cognos_proposedpayrollregisterearnings TO skybotsu;
