-- public.cognos_payrollregistersummary_winter_mv source

--CREATE MATERIALIZED VIEW public.cognos_payrollregistersummary_winter_mv TABLESPACE pg_default AS 
...
ALTER TABLE public.cognos_payrollregistersummary_winter_mv OWNER TO ehcmuser;
GRANT ALL ON TABLE public.cognos_payrollregistersummary_winter_mv TO ehcmuser;
GRANT SELECT ON TABLE public.cognos_payrollregistersummary_winter_mv TO read_only;
GRANT INSERT, SELECT, UPDATE, DELETE, TRUNCATE ON TABLE public.cognos_payrollregistersummary_winter_mv TO read_write;
