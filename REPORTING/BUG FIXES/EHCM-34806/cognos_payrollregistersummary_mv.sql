-- payroll.cognos_payrollregistersummary_mv source

--CREATE MATERIALIZED VIEW payroll.cognos_payrollregistersummary_mv TABLESPACE pg_default AS 
...
ALTER TABLE payroll.cognos_payrollregistersummary_mv OWNER TO ehcmuser;
...
GRANT INSERT, SELECT, UPDATE, DELETE, TRUNCATE ON TABLE payroll.cognos_payrollregistersummary_mv TO read_write;
*/