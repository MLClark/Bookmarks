WITH pte AS
 ...
 LEFT JOIN company_parameters cp on 1 = 1 and cp.companyparametername = 'PInt' and cp.companyparametervalue = 'PSPAY'
 ...
 LEFT JOIN company_parameters cp on 1 = 1 and cp.companyparametername = 'PInt' and cp.companyparametervalue = 'P20'
