-- Materialized View: PAYROLL.cognos_pspaypayrollregisterdeductions_mv

-- DROP MATERIALIZED VIEW PAYROLL.cognos_pspaypayrollregisterdeductions_mv;

--CREATE MATERIALIZED VIEW PAYROLL.cognos_pspaypayrollregisterdeductions_mv AS 
 ...
 SELECT ph.personid,
   ...
   where pd.paycode = 'VA3' --and pd.personid = '4510'
...
ALTER TABLE PAYROLL.cognos_pspaypayrollregisterdeductions_mv
  OWNER TO postgres;
GRANT ALL ON TABLE PAYROLL.cognos_pspaypayrollregisterdeductions_mv TO postgres;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE PAYROLL.cognos_pspaypayrollregisterdeductions_mv TO read_write;
GRANT SELECT ON TABLE PAYROLL.cognos_pspaypayrollregisterdeductions_mv TO read_only;
