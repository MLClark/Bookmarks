...
ALTER TABLE payroll.cognos_payrollregistersummary_winter_mv
  OWNER TO postgres;
GRANT ALL ON TABLE payroll.cognos_payrollregistersummary_winter_mv TO postgres;
GRANT SELECT ON TABLE payroll.cognos_payrollregistersummary_winter_mv TO read_only;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE payroll.cognos_payrollregistersummary_winter_mv TO read_write;