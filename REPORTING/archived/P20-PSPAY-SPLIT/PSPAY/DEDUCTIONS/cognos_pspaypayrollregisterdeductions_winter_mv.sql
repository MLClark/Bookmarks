CREATE MATERIALIZED VIEW public.cognos_pspaypayrollregisterdeductions_winter_mv AS 
 SELECT ph.personid,
    ph.paymentheaderid,
    pp.pspaypayrollid,
...
ALTER TABLE public.cognos_pspaypayrollregisterdeductions_winter_mv
  OWNER TO postgres;
GRANT ALL ON TABLE public.cognos_pspaypayrollregisterdeductions_winter_mv TO postgres;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE public.cognos_pspaypayrollregisterdeductions_winter_mv TO read_write;
GRANT SELECT ON TABLE public.cognos_pspaypayrollregisterdeductions_winter_mv TO read_only;
