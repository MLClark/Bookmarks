CREATE MATERIALIZED VIEW public.cognos_pspaypayrollregisterearnings_winter_mv AS 
 SELECT ph.personid,
    ph.paymentheaderid,
    pp.pspaypayrollid,
...
ALTER TABLE public.cognos_pspaypayrollregisterearnings_winter_mv
  OWNER TO postgres;
GRANT ALL ON TABLE public.cognos_pspaypayrollregisterearnings_winter_mv TO postgres;
GRANT SELECT, UPDATE, INSERT, DELETE ON TABLE public.cognos_pspaypayrollregisterearnings_winter_mv TO read_write;
GRANT SELECT ON TABLE public.cognos_pspaypayrollregisterearnings_winter_mv TO read_only;

CREATE INDEX ix_cognos_pspaypayrollregisterearnings_winter_mv
  ON public.cognos_pspaypayrollregisterearnings_winter_mv
  USING btree
  (paymentheaderid);
