DROP MATERIALIZED VIEW IF EXISTS public.cognos_pspaypayrollregistertaxes_mv;
...
SELECT ph.personid,
 ...
 LEFT JOIN company_parameters cp cp.companyparametername = 'PInt'
 ...
 JOIN (select distinct date_part('year',periodpaydate) as tlayear, taxrank.ttype_tax_code, taxrank.etvid_lookups, pte.taxid, pte.personid , taxrank.taxrank
...
) pte ON pte.personid = ph.personid 
