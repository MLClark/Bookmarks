...
--		ed.emplstatus,
		case
			when ed.emplstatus = 'T' then to_char(pe.paythroughdate, 'YYYYMMdd')
			else ' '
		end::char(8) as TermDate,  -- position 619-626 - 10/30/2020 change to use paythrough date. This change required adding terms to the file.
