...
join person_bene_election pbesups
  on pbesups.personid = pi.personid
 and pbesups.benefitsubclass in ('2Z')
 and pbesups.selectedoption = 'Y' 
 and pbesups.benefitelection in ('T','W')
 and pbesups.effectivedate < pbesups.enddate
 and current_timestamp between pbesups.createts and pbesups.endts
 and pbesups.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts and date_part('year',deductionstartdate)=date_part('year',current_date)
...
where pi.identitytype = 'SSN'
  ...
  and ((pe.effectivedate >= elu.lastupdatets::DATE 
   ...
   or (pbesups.effectivedate >= elu.lastupdatets::DATE 
   or (pbesups.createts > elu.lastupdatets and pbesups.effectivedate < coalesce(elu.lastupdatets, '2017-01-01')) ))
...
,elu.lastupdatets
,'0' AS dependentid
,'ACTIVE EE FD TRM SUPS(2Z)'::varchar(30) as qsource
,'E' ::char(1) as transcode
,'5923955' ::char(7) as custnbr 
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
...
,elu.lastupdatets 
,pdr.dependentid 
,'ACTIVE EE DEP SUPS(2Z)'::varchar(30) as qsource
...
join person_bene_election pbesups
 ...
 and pbesups.benefitelection = 'E'
 and pbesups.selectedoption = 'Y' 
 and pbesups.enddate > current_date   
 and pbesups.benefitsubclass in ('2Z')  
 and current_date between pbesups.effectivedate and pbesups.enddate
 and current_timestamp between pbesups.createts and pbesups.endts
...
join person_dependent_relationship pdr
  on pdr.personid = pbesups.personid
 and current_date between pdr.effectivedate and pdr.enddate
 and current_timestamp between pdr.createts and pdr.endts
 
join dependent_enrollment de
  on de.dependentid = pdr.dependentid
 and de.personid = pbesups.personid
 and de.benefitsubclass = pbesups.benefitsubclass
...
,elu.lastupdatets 
,pdr.dependentid 
,'TERMED EE DEP SUPS(2Z)'::varchar(30) as qsource
,'D' ::char(1) as transcode
,'5923955' ::char(7) as custnbr
...
left join (SELECT personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, MAX(effectivedate) AS effectivedate, MAX(enddate) AS enddate, 
           ...
           WHERE effectivedate < enddate  and current_timestamp BETWEEN createts and endts and benefitsubclass in ('2Z') and benefitelection in ( 'E','T')  and selectedoption = 'Y' 
...
,elu.lastupdatets 
,pdr.dependentid 
,'ACTIVE EE TERMED DEP SUPS(2Z)'::varchar(30) as qsource
,'D' ::char(1) as transcode
,'5923955' ::char(7) as custnbr
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
...
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '2Z' and benefitelection = 'E' and selectedoption = 'Y' and (effectivedate < enddate or (effectivedate > current_date and enddate > effectivedate)) and current_timestamp between createts and endts and benefitcoverageid > '1' 
 ...
 ( select distinct de.dependentid as dependentid
   ...
   (select distinct de.dependentid from dependent_enrollment de
     ...
     where current_date between de.effectivedate and de.enddate
       and current_timestamp between de.createts and de.endts
       and de.benefitsubclass in ('2Z')  -- and de.dependentid = '1964'
       --and pdr.dependentrelationship in ('S','D','C','NC','NS','ND')
   )
)     
left join person_identity piD
