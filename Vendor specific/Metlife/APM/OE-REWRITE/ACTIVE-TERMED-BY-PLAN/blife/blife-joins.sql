...
join person_bene_election pbeblife
 ...
 and pbeblife.benefitsubclass in ('20')
 and pbeblife.selectedoption = 'Y' 
 and pbeblife.benefitelection in ('T','W')
 and pbeblife.effectivedate < pbeblife.enddate
 and current_timestamp between pbeblife.createts and pbeblife.endts
 and pbeblife.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts and date_part('year',deductionstartdate)=date_part('year',current_date)
...
where pi.identitytype = 'SSN'
  ...
  and ((pe.effectivedate >= elu.lastupdatets::DATE 
   ...
   or (pbeblife.effectivedate >= elu.lastupdatets::DATE 
   or (pbeblife.createts > elu.lastupdatets and pbeblife.effectivedate < coalesce(elu.lastupdatets, '2017-01-01')) ))
...
,elu.lastupdatets
,'0' AS dependentid
,'ACTIVE EE FD TRM BLIFE(20) BENEFITS'::varchar(30) as qsource
,'E' ::char(1) as transcode
,'5923955' ::char(7) as custnbr 
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
