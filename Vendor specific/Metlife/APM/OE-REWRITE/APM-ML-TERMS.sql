...
left join (SELECT personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, createts, MAX(effectivedate) AS effectivedate, MAX(enddate) AS enddate, 
           ...
           WHERE effectivedate < enddate  and current_timestamp BETWEEN createts and endts and benefitsubclass in ('11') and benefitelection in ( 'E')  and selectedoption = 'Y' 
             and (createts > elu.lastupdatets and effectivedate < coalesce(elu.lastupdatets, '2017-01-01')) GROUP BY personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, createts) as pbednt on pbednt.personid = pbe.personid and pbednt.rank = 1 
...
,elu.lastupdatets 
,'0' AS dependentid
,'TERMED EE BLIFE(20)'::varchar(30) as qsource
,'E' ::char(1) as transcode
,'5923955' ::char(7) as custnbr 
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
...
join person_bene_election pbe
 ...
 and current_timestamp between pbe.createts and pbe.endts
 and pbe.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts 
                         and benefitsubclass in ('20')  and benefitelection = 'E' and selectedoption = 'Y' and effectivedate < enddate) 
...
,elu.lastupdatets 
,'0' AS dependentid
,'TERMED EE LTD(31)'::varchar(30) as qsource
,'E' ::char(1) as transcode
,'5923955' ::char(7) as custnbr 
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
...
join person_bene_election pbe
 ...
 and current_timestamp between pbe.createts and pbe.endts
 and pbe.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts 
                         and benefitsubclass in ('31')  and benefitelection = 'E' and selectedoption = 'Y' and effectivedate < enddate) 
...
,elu.lastupdatets 
,'0' AS dependentid
,'TERMED EE SUPS(2Z)'::varchar(30) as qsource
,'E' ::char(1) as transcode
,'5923955' ::char(7) as custnbr 
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
...
join person_bene_election pbe
 ...
 and current_timestamp between pbe.createts and pbe.endts
 and pbe.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts 
                         and benefitsubclass in ('2Z')  and benefitelection = 'E' and selectedoption = 'Y' and effectivedate < enddate) 
...
left join (SELECT personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, personbeneelectionpid, MAX(effectivedate) AS effectivedate, MAX(enddate) AS enddate, 
           ...
           WHERE effectivedate < enddate  and current_timestamp BETWEEN createts and endts and benefitsubclass in ('2Z') and benefitelection in ( 'E')  and selectedoption = 'Y' 
             and effectivedate <= elu.lastupdatets GROUP BY personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, personbeneelectionpid) as pbesups on pbesups.personid = pbe.personid and pbesups.rank = 1                           
...
join person_bene_election pbe
 ...
 and current_timestamp between pbe.createts and pbe.endts
 and pbe.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts 
                         and benefitsubclass in ('25')  and benefitelection = 'E' and selectedoption = 'Y' and effectivedate < enddate) 
...
left join (SELECT personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, personbeneelectionpid, MAX(effectivedate) AS effectivedate, MAX(enddate) AS enddate, 
           ...
           WHERE effectivedate < enddate  and current_timestamp BETWEEN createts and endts and benefitsubclass in ('25') and benefitelection in ( 'E')  and selectedoption = 'Y' 
             and effectivedate <= elu.lastupdatets GROUP BY personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, personbeneelectionpid) as pbesupc on pbesupc.personid = pbe.personid and pbesupc.rank = 1    
...
left join (SELECT personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, personbeneelectionpid, MAX(effectivedate) AS effectivedate, MAX(enddate) AS enddate, 
           ...
           WHERE effectivedate < enddate  and current_timestamp BETWEEN createts and endts and benefitsubclass in ('14') and benefitelection in ( 'E')  and selectedoption = 'Y' 
             and effectivedate <= elu.lastupdatets GROUP BY personid, benefitsubclass, benefitelection, benefitcoverageid, coverageamount, personbeneelectionpid) as pbevsn on pbevsn.personid = pbe.personid and pbevsn.rank = 1    
