...
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitelection = 'T' then to_char(pbednt.effectivedate,'MMDDYYYY') 
      when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_end
...
,case when pbeblife.effectivedate - interval '14 days' <= current_date and pbeblife.benefitsubclass = '20' and pbeblife.benefitelection = 'T' then to_char(pbeblife.enddate,'MMDDYYYY') 
      when pbeblife.effectivedate - interval '14 days' <= current_date and pbeblife.benefitsubclass = '20' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as cp_cov_end
...
,case when pbesupe.effectivedate - interval '14 days' <= current_date and pbesupe.benefitsubclass = '21' and pbesupe.benefitelection = 'T' then to_char(pbesupe.enddate,'MMDDYYYY') 
      when pbesupe.effectivedate - interval '14 days' <= current_date and pbesupe.benefitsubclass = '21' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as ad_cov_end
...
,case when pbeltd.effectivedate - interval '14 days' <= current_date and pbeltd.benefitsubclass = '31' and pbeltd.benefitelection = 'T' then to_char(pbeltd.enddate,'MMDDYYYY') 
      when pbeltd.effectivedate - interval '14 days' <= current_date and pbeltd.benefitsubclass = '31' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lt_cov_end
...
,case when pbestd.effectivedate - interval '14 days' <= current_date and pbestd.benefitsubclass = '30' and pbestd.benefitelection = 'T' then to_char(pbestd.enddate,'MMDDYYYY') 
      when pbestd.effectivedate - interval '14 days' <= current_date and pbestd.benefitsubclass = '30' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as as_cov_end
...
,case when pbesupe.effectivedate - interval '14 days' <= current_date and pbesupe.benefitsubclass = '21' and pbesupe.benefitelection = 'T' then to_char(pbesupe.enddate,'MMDDYYYY') 
      when pbesupe.effectivedate - interval '14 days' <= current_date and pbesupe.benefitsubclass = '21' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as op_cov_end
...
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pbesupc.benefitelection = 'T' then to_char(pbesupc.enddate,'MMDDYYYY') 
      when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_end
...
,case when pbesupe.effectivedate - interval '14 days' <= current_date and pbesupe.benefitsubclass = '21' and pbesupe.benefitelection = 'T' then to_char(pbesupe.enddate,'MMDDYYYY') 
      when pbesupe.effectivedate - interval '14 days' <= current_date and pbesupe.benefitsubclass = '21' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as od_cov_end
...
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pbesupc.benefitelection = 'T' then to_char(pbesupc.enddate,'MMDDYYYY') 
      when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_end
...
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitelection = 'T' then to_char(pbevsn.effectivedate,'MMDDYYYY') 
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pe.emplstatus = 'T' then to_char(pe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_end
...
----------------------------------------------------------
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '20' and benefitelection = 'E' and selectedoption = 'Y' and (current_date between effectivedate and enddate or (effectivedate > current_date and enddate > effectivedate)) and current_timestamp between createts and endts 
...
---------------------------------------------------------------------------  
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '21' and benefitelection = 'E' and selectedoption = 'Y' and (current_date between effectivedate and enddate or (effectivedate > current_date and enddate > effectivedate)) and current_timestamp between createts and endts 
...
left join benefit_coverage_desc bcdsupe
  on bcdsupe.benefitcoverageid = pbesupe.benefitcoverageid
 and current_date between bcdsupe.effectivedate and bcdsupe.enddate
 and current_timestamp between bcdsupe.createts and bcdsupe.endts   
----------------------------------------------------------
---- start ltd 31 columns 456 - 518  EMPLOYEE ONLY   -----
----------------------------------------------------------
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '31' and benefitelection = 'E' and selectedoption = 'Y' and (current_date between effectivedate and enddate or (effectivedate > current_date and enddate > effectivedate)) and current_timestamp between createts and endts 
...
----------------------------------------------------------
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '30' and benefitelection = 'E' and selectedoption = 'Y' and (current_date between effectivedate and enddate or (effectivedate > current_date and enddate > effectivedate)) and current_timestamp between createts and endts 
...
---- start dental 11 columns 267 - 329 Based on Coverage Description -----
--------------------------------------------------------------------------
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then 'D ' else null end ::char(2) as d_covcode
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then to_char(pbednt.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_start
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and pe.emplstatus in ('T','R') then to_char(pe.effectivedate,'MMDDYYYY')
      when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and pbednt.benefitelection in ('T') then to_char(pbednt.enddate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_end
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '5923955' else ' ' end ::char(7) as d_grp_nbr
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '0001' else ' ' end ::char(4) as d_sub_cd
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '0001' else ' ' end ::char(4) as d_branch
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then pa.stateprovincecode else ' ' end ::char(2) as d_plan_cd
----- d_status Based on Employment Status 
----- R for Retirement
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (d_cov_end)
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and pe.emplstatus = 'R' then 'R' 
      when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as d_status
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and bcddnt.benefitcoveragedesc = 'Employee Only' then '1'
      when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and bcddnt.benefitcoveragedesc in ('EE & 1 Dep or More','Employee + Children') then '2' 
      when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and bcddnt.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and bcddnt.benefitcoveragedesc in ('EE & Child(ren) + D/P Adult','EE&1+DPAdult &/or DPChild(ren)','EE&2+DPAdult &/or DPChild(ren)','EE&Child(ren) + DP Adult&DP Ch','Family') then '4'
      else ' ' end ::char(1) AS d_mbrs_covered
,' ' ::char(2) as d_cancel_rsn
,' ' ::char(1) as d_filler_306
,' ' ::char(8) as d_facility_id
...
---- start Supplemental Spouse Life 2Z columns 708 - 770 SPOUSE ONLY -----
--------------------------------------------------------------------------      
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'LZ' else ' ' end ::char(2) as lz_covcode
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(pbesups.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_start
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pe.emplstatus in ('T','R') then to_char(pe.effectivedate,'MMDDYYYY')
      when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pbesups.benefitelection in ('T') then to_char(pbesups.enddate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_end
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '5923955' else ' ' end ::char(7) as lz_grp_nbr
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as lz_sub_cd
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as lz_branch
,' ' ::char(2) as lz_filler_741_742
----- lz_status Based on Employment Status 
----- R for Retirement
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (lz_cov_end)
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pe.emplstatus = 'R' then 'R' 
      when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as lz_status
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'A' else ' ' end ::char(1) AS lz_mbrs_covered
,' ' ::char(10) as lz_filler_745_754
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(pbesups.coverageamount, 'FM00000000') else ' ' end ::char(8) as lz_annual_benefit_amt
,' ' ::char(8) as lz_filler_763_770
------------------------------------------------------------------------------            
---- start Supplemental Child Life 25 columns 771 - 833  CHILD(REN) ONLY -----
------------------------------------------------------------------------------  
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'LF' else ' ' end ::char(2) as lf_covcode
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(pbesupc.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_start
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pe.emplstatus in ('T','R') then to_char(pe.effectivedate,'MMDDYYYY')
      when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pbesupc.benefitelection in ('T') then to_char(pbesupc.enddate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_end
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '5923955' else ' ' end ::char(7) as lf_grp_nbr
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as lf_sub_cd
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as lf_branch
,' ' ::char(2) as lf_filler_804_805
----- lf_status Based on Employment Status 
----- R for Retirement
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (lf_cov_end)
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pe.emplstatus = 'R' then 'R' 
      when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as lf_status
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'C' else ' ' end ::char(1) AS lf_mbrs_covered 
,' ' ::char(10) as lf_filler_808_817
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(pbesupc.coverageamount, 'FM00000000') else ' ' end ::char(8) as lf_annual_benefit_amt
,' ' ::char(8) as lf_filler_826_833
---------------------------------------------------------------------------            
---- start Supplemental Basic AD&D 21 columns 834 - 896 EMPLOYEE ONLY -----
---------------------------------------------------------------------------  
...
---- start Supplemental Spouse AD&D 2Z columns 897 - 959 SPOUSE ONLY -----
--------------------------------------------------------------------------  
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'AE' else ' ' end ::char(2) as ae_covcode
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(pbesups.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_start
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pe.emplstatus in ('T','R') then to_char(pe.effectivedate,'MMDDYYYY')
      when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pbesups.benefitelection in ('T') then to_char(pbesups.enddate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_end
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '5923955' else ' ' end ::char(7) as ae_grp_nbr
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as ae_sub_cd
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as ae_branch
,' ' ::char(2) as ae_filler_930_931
----- ae_status Based on Employment Status 
----- R for Retirement
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (ae_cov_end)
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pe.emplstatus = 'R' then 'R' 
      when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as ae_status
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'A' else ' ' end ::char(1) AS ae_mbrs_covered
,' ' ::char(10) as ae_filler_934_943
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(pbesups.coverageamount, 'FM00000000') else ' ' end ::char(8) as ae_annual_benefit_amt
,' ' ::char(8) as ae_filler_952_959
------------------------------------------------------------------------------            
---- start Supplemental Child AD&D 25 columns 960 - 1022 CHILD(REN) ONLY -----
------------------------------------------------------------------------------  
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'AT' else ' ' end ::char(2) as at_covcode
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(pbesupc.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_start
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pe.emplstatus in ('T','R') then to_char(pe.effectivedate,'MMDDYYYY')
      when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pbesupc.benefitsubclass in ('T') then to_char(pbesupc.enddate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_end
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '5923955' else ' ' end ::char(7) as at_grp_nbr
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as at_sub_cd
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as at_branch
,' ' ::char(2) as at_filler_993_994
----- at_status Based on Employment Status 
----- R for Retirement
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (at_cov_end)
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pe.emplstatus = 'R' then 'R' 
      when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as at_status
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'C' else ' ' end ::char(1) AS at_mbrs_covered
,' ' ::char(10) as at_filler_997_1006
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(pbesupc.coverageamount, 'FM00000000') else ' ' end ::char(8) as at_annual_benefit_amt
,' ' ::char(8) as at_filler_1015_1022
------------------------------------------------------------------------            
---- start BuyUp Spouse Life ?? columns 1023 - 1085 Don'T POPULATE -----
------------------------------------------------------------------------  
...
---- start Vision 14 columns 1279 - 1340 Based on Coverage Description -----
----------------------------------------------------------------------------  
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then 'VV' else ' ' end ::char(2) as vv_covcode
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then to_char(pbevsn.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_start
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pe.emplstatus in ('T','R') then to_char(pe.effectivedate,'MMDDYYYY')
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pbevsn.benefitelection in ('T') then to_char(pbevsn.enddate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_end
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '5923955' else ' ' end ::char(7) as vv_grp_nbr
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '0001' else ' ' end ::char(4) as vv_sub_cd
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '0001' else ' ' end ::char(4) as vv_branch
,' ' ::char(2) as vv_filler_1312_1313
----- vv_status Based on Employment Status 
----- R for Retirement
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (vv_cov_end)
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1' and pe.emplstatus = 'R' then 'R' 
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as vv_status
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc = 'Employee Only' then '1'
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc in ('EE & 1 Dep or More','Employee + Children') then '2' 
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc in ('EE & Child(ren) + D/P Adult','EE&1+DPAdult &/or DPChild(ren)','EE&2+DPAdult &/or DPChild(ren)','EE&Child(ren) + DP Adult&DP Ch','Family') then '4'
      else ' ' end ::char(1) AS vv_mbrs_covered
,' ' ::char(2) as vv_cancel_rsn
,' ' ::char(23) as vv_filler_1318_1340
...
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then 'D ' else null end ::char(2) as d_covcode
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then to_char(pbednt.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_start
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' and pbednt.benefitelection = 'T' then to_char(pbednt.enddate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_end
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '5923955' else ' ' end ::char(7) as d_grp_nbr
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '0001' else ' ' end ::char(4) as d_sub_cd
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '0001' else ' ' end ::char(4) as d_branch
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then pa.stateprovincecode else ' ' end ::char(2) as d_plan_cd
...
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'LZ' else ' ' end ::char(2) as lz_covcode
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(pbesups.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_start
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pbesups.benefitelection = 'T' then to_char(pbesups.enddate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_end
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '5923955' else ' ' end ::char(7) as lz_grp_nbr
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as lz_sub_cd
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as lz_branch
,' ' ::char(2) as lz_filler_741_742
...
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'LF' else ' ' end ::char(2) as lf_covcode
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(pbesupc.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_start
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pbesupc.benefitelection = 'T' then to_char(pbesupc.enddate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_end
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '5923955' else ' ' end ::char(7) as lf_grp_nbr
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as lf_sub_cd
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as lf_branch
,' ' ::char(2) as lf_filler_804_805
...
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'AE' else ' ' end ::char(2) as ae_covcode
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(pbesups.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_start
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') and pbesups.benefitelection = 'T' then to_char(pbesups.enddate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_end
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '5923955' else ' ' end ::char(7) as ae_grp_nbr
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as ae_sub_cd
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as ae_branch
,' ' ::char(2) as ae_filler_930_931
...
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'AT' else ' ' end ::char(2) as at_covcode
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(pbesupc.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_start
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') and pbesupc.benefitelection in ('T') then to_char(pbesupc.enddate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_end
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '5923955' else ' ' end ::char(7) as at_grp_nbr
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as at_sub_cd
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as at_branch
,' ' ::char(2) as at_filler_993_994
...
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then 'VV' else ' ' end ::char(2) as vv_covcode
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then to_char(pbevsn.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_start
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pbevsn.benefitelection = 'T' then to_char(pbevsn.enddate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_end
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '5923955' else ' ' end ::char(7) as vv_grp_nbr
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '0001' else ' ' end ::char(4) as vv_sub_cd
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '0001' else ' ' end ::char(4) as vv_branch
,' ' ::char(2) as vv_filler_1312_1313
...
--------------------------------------------------------------------------
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then 'D ' else null end ::char(2) as d_covcode
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then to_char(de.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_start
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then to_char(de.enddate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_end
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '5923955' else ' ' end ::char(7) as d_grp_nbr
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '0001' else ' ' end ::char(4) as d_sub_cd
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then '0001' else ' ' end ::char(4) as d_branch
,case when pbednt.effectivedate - interval '14 days' <= current_date and pbednt.benefitsubclass = '11' and pbednt.benefitcoverageid > '1' then pa.stateprovincecode else ' ' end ::char(2) as d_plan_cd
...
--------------------------------------------------------------------------      
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'LZ' else ' ' end ::char(2) as lz_covcode
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(de.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_start
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(de.enddate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_end
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '5923955' else ' ' end ::char(7) as lz_grp_nbr
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as lz_sub_cd
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as lz_branch
,' ' ::char(2) as lz_filler_741_742
...
------------------------------------------------------------------------------  
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'LF' else ' ' end ::char(2) as lf_covcode
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(de.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_start
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(de.enddate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_end
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '5923955' else ' ' end ::char(7) as lf_grp_nbr
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as lf_sub_cd
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as lf_branch
,' ' ::char(2) as lf_filler_804_805
...
--------------------------------------------------------------------------  
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then 'AE' else ' ' end ::char(2) as ae_covcode
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(de.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_start
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then to_char(de.enddate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_end
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '5923955' else ' ' end ::char(7) as ae_grp_nbr
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as ae_sub_cd
,case when pbesups.effectivedate - interval '14 days' <= current_date and pbesups.benefitsubclass = '2Z' and pdr.dependentrelationship in ('SP','DP','NA') then '0001' else ' ' end ::char(4) as ae_branch
,' ' ::char(2) as ae_filler_930_931
...
------------------------------------------------------------------------------  
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then 'AT' else ' ' end ::char(2) as at_covcode
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(de.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_start
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then to_char(de.enddate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_end
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '5923955' else ' ' end ::char(7) as at_grp_nbr
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as at_sub_cd
,case when pbesupc.effectivedate - interval '14 days' <= current_date and pbesupc.benefitsubclass = '25' and pdr.dependentrelationship in ('S','D','C','NS','ND','NC') then '0001' else ' ' end ::char(4) as at_branch
,' ' ::char(2) as at_filler_993_994
...
----------------------------------------------------------------------------  
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1' then 'VV' else ' ' end ::char(2) as vv_covcode
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then to_char(de.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_start
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then to_char(de.enddate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_end
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '5923955' else ' ' end ::char(7) as vv_grp_nbr
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '0001' else ' ' end ::char(4) as vv_sub_cd
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'then '0001' else ' ' end ::char(4) as vv_branch
,' ' ::char(2) as vv_filler_1312_1313
...
----- A for Active and all others
----- Note: terms will have an A, but will send Benefit End Date in Stop Date field (vv_cov_end)
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pbevsn.benefitcoverageid > '1' and pe.emplstatus = 'R' then 'R' 
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pbevsn.benefitcoverageid > '1' and pe.emplstatus <> 'R' then 'A' else ' ' end ::char(1) as vv_status
,case when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and pbevsn.benefitcoverageid > '1' and bcdvsn.benefitcoveragedesc = 'Employee Only' then '1'
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc in ('EE & 1 Dep or More','Employee + Children') then '2' 
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbevsn.effectivedate - interval '14 days' <= current_date and pbevsn.benefitsubclass = '14' and pbevsn.benefitcoverageid > '1'and bcdvsn.benefitcoveragedesc in ('EE & Child(ren) + D/P Adult','EE&1+DPAdult &/or DPChild(ren)','EE&2+DPAdult &/or DPChild(ren)','EE&Child(ren) + DP Adult&DP Ch','Family') then '4'
      else ' ' end ::char(1) AS vv_mbrs_covered
