...
,'CP' ::char(2) as life_covcode
,to_char(pbe.effectivedate,'MMDDYYYY') ::char(8) as life_cov_start
,case when pbe.benefitelection = 'T' then to_char(pbe.enddate,'MMDDYYYY') else ' ' end ::char(8) as life_cov_end
,'5923955' ::char(7) as life_grp_nbr
,'0001' ::char(4) as life_sub_cd
,'0001' ::char(4) as life_branch
,' ' ::char(2) as life_filler_363_364
,pe.emplstatus ::char(1) as life_status
,bcd.benefitcoveragedesc
,pbe.benefitcoverageid
,'1' ::char(1) AS life_mbrs_covered
,' ' ::char(10) as life_filler_367_376
...
,case when pc.frequencycode = 'H' then to_char(pc.compamount * 100,'FM0000000') 
      ...
      else to_char(pc.compamount * 100,'FM0000000') end ::char(8) as life_salary_amount
