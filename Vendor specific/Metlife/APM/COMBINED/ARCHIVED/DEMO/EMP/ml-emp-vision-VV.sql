...
,to_char(pbe.effectivedate,'MMDDYYYY') ::char(8) as vv_cov_start
,case when pbe.benefitelection = 'T' then to_char(pbe.effectivedate,'MMDDYYYY') 
      ...
      else ' ' end ::char(8) as vv_cov_end
,'5923955' ::char(7) as vv_grp_nbr
,'0001' ::char(4) as vv_sub_cd
,'0001' ::char(4) as vv_branch
,' ' ::char(2) as vv_filler_1312_1313
,pe.emplstatus ::char(1) ::char(1) as v_status
...
,' ' ::char(15) as vv_filler_1318_1340
