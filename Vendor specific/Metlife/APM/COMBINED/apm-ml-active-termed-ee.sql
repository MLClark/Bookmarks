...
,pe.emplstatus
,'0' AS dependentid
,'EE FUTURE DATED TERMED W ACTIVE BENEFITS'::varchar(30) as qsource
...
,case when pbednt.benefitsubclass = '11' then to_char(curdnt.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as d_cov_start
,case when pbednt.benefitsubclass = '11' and pbednt.benefitelection in ('T','W') then to_char(curdnt.enddate,'MMDDYYYY') 
...
,case when pbeblife.benefitsubclass = '20' then to_char(curblife.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as cp_cov_start
,case when pbeblife.benefitsubclass = '20' and pbeblife.benefitelection in ('T','W') then to_char(curblife.enddate,'MMDDYYYY') 
...
,case when pbesupe.benefitsubclass = '21' then to_char(cursupe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as ad_cov_start
,case when pbesupe.benefitsubclass = '21' and pbesupe.benefitelection in ('T','W') then to_char(cursupe.enddate,'MMDDYYYY') 
...
,case when pbeltd.benefitsubclass = '31' then to_char(curltd.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lt_cov_start
,case when pbeltd.benefitsubclass = '31' and pbeltd.benefitelection in ('T','W') then to_char(curltd.enddate,'MMDDYYYY') 
...
,case when pbestd.benefitsubclass = '30' then to_char(curstd.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as as_cov_start
,case when pbestd.benefitsubclass = '30' and pbestd.benefitelection in ('T','W') then to_char(curstd.enddate,'MMDDYYYY') 
...
,case when pbesupe.benefitsubclass = '21' then to_char(cursupe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as op_cov_start
,case when pbesupe.benefitsubclass = '21' and pbesupe.benefitelection in ('T','W') then to_char(cursupe.enddate,'MMDDYYYY') 
...
,case when pbesups.benefitsubclass = '2Z' then to_char(cursups.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lz_cov_start
,case when pbesups.benefitsubclass = '2Z' and pbesups.benefitelection in ('T','W') then to_char(cursups.enddate,'MMDDYYYY') 
...
,case when pbesupc.benefitsubclass = '25' then to_char(cursupc.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as lf_cov_start
,case when pbesupc.benefitsubclass = '25' and pbesupc.benefitelection in ('T','W') then to_char(cursupc.enddate,'MMDDYYYY') 
...
,case when pbesupe.benefitsubclass = '21' then to_char(cursupe.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as od_cov_start
,case when pbesupe.benefitsubclass = '21' and pbesupe.benefitelection in ('T','W') then to_char(cursupe.enddate,'MMDDYYYY') 
...
,case when pbesups.benefitsubclass = '2Z' then to_char(cursups.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as ae_cov_start
,case when pbesups.benefitsubclass = '2Z' and pbesups.benefitelection in ('T','W') then to_char(cursups.enddate,'MMDDYYYY') 
...
,case when pbesupc.benefitsubclass = '25' then to_char(cursupc.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as at_cov_start
,case when pbesupc.benefitsubclass = '25' and pbesupc.benefitelection in ('T','W') then to_char(cursupc.enddate,'MMDDYYYY') 
...
,case when pbevsn.benefitsubclass = '14' then to_char(curvsn.effectivedate,'MMDDYYYY') else ' ' end ::char(8) as vv_cov_start
,case when pbevsn.benefitsubclass = '14' and pbevsn.benefitelection in ('T','W') then to_char(curvsn.effectivedate,'MMDDYYYY') 
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
            ...
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) pbeblife on pbeblife.personid = pbe.personid and pbeblife.rank = 1  

left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('20') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) curblife on curblife.personid = pbe.personid and curblife.rank = 1      
----------------------------------------------------------
---- start AD&D 21 columns 393 - 455 EMPLOYEE ONLY   -----
----------------------------------------------------------
---------------------------------------------------------------------------            
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('21') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) cursupe on cursupe.personid = pbe.personid and cursupe.rank = 1   
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
            ...
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) pbeltd on pbeltd.personid = pbe.personid and pbeltd.rank = 1  

left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('31') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) curltd on curltd.personid = pbe.personid and curltd.rank = 1   
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('30') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) curstd on curstd.personid = pbe.personid and curstd.rank = 1   
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
            ...
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) pbesupc on pbesupc.personid = pbe.personid and pbesupc.rank = 1  

left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('25') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) cursupc on cursupc.personid = pbe.personid and cursupc.rank = 1   
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
            ...
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) pbesups on pbesups.personid = pbe.personid and pbesups.rank = 1  

left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('2Z') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) cursups on cursups.personid = pbe.personid and cursups.rank = 1               
----------------------------------------------------------------------------            
---- start Vision 14 columns 1279 - 1340 Based on Coverage Description -----
----------------------------------------------------------------------------  
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
...
left join (select pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount, max(pbe.effectivedate) as effectivedate, max(pbe.enddate) as enddate,RANK() over (partition by pbe.personid order by max(pbe.effectivedate) DESC) AS RANK
             from person_bene_election pbe  
            where benefitsubclass in ('14') and selectedoption = 'Y' and benefitelection = 'E' and current_timestamp between createts and endts and current_date between effectivedate and enddate and date_part('year',deductionstartdate) = date_part('year',current_date - interval '1 year')
            group by pbe.personid, pbe.benefitelection, pbe.benefitcoverageid, pbe.benefitsubclass, pbe.benefitplanid, pbe.personbeneelectionpid, pbe.coverageamount) curvsn on curvsn.personid = pbe.personid and curvsn.rank = 1      
...
where pi.identitytype = 'SSN'
  ...
  and ((pbevsn.benefitelection in ('T','W') and curvsn.benefitelection = 'E')
    or (pbesups.benefitelection in ('T','W') and cursups.benefitelection = 'E')
    or (pbesupc.benefitelection in ('T','W') and cursupc.benefitelection = 'E')
    or (pbestd.benefitelection in ('T','W') and curstd.benefitelection = 'E')
    or (pbeltd.benefitelection in ('T','W') and curltd.benefitelection = 'E')
    or (pbesupe.benefitelection in ('T','W') and cursupe.benefitelection = 'E')
    or (pbeblife.benefitelection in ('T','W') and curblife.benefitelection = 'E')
    or (pbednt.benefitelection in ('T','W') and curdnt.benefitelection = 'E')
    )
