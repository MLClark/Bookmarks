...
,curr.enbr ::char(11) as enbr
,' ' ::char(11) as filler_20_30
,curr.member_ssn  ::char(9) as member_ssn 
,curr.member_lname ::char(20) as member_lname
,curr.member_fname ::char(12) as member_fname
,curr.member_mi ::char(1)  as member_mi
,curr.member_dob::char(8) as member_dob
,curr.member_maritalstatus ::char(1) as member_maritalstatus
,curr.member_gender ::char(1) as member_gender
,'00' ::char(2) as member_relcode
,curr.emp_doh ::char(8) as emp_doh
,' ' ::char(11) as personnel_id
,curr.emp_smoker ::char(1) as emp_smoker
...
,curr.addr ::char(32) as addr
,curr.city ::char(21) as city
,curr.state ::char(2) as state
,curr.zip ::char(9) as zip
------------------------------------------------------------------------------
---- start dental (D) 11 columns 267 - 329 Based on Coverage Description -----
------------------------------------------------------------------------------
,coalesce(curr.d_covcode,fd.d_covcode)::char(2) as d_covcode
,coalesce(curr.d_cov_start,fd.d_cov_start)::char(8) as d_cov_start
,coalesce(curr.d_cov_end,fd.d_cov_end)::char(8) as d_cov_end
,coalesce(curr.d_grp_nbr,fd.d_grp_nbr)::char(7) as d_grp_nbr
,coalesce(curr.d_sub_cd,fd.d_sub_cd)::char(4) as d_sub_cd
,coalesce(curr.d_branch,fd.d_branch)::char(4) as d_branch
,coalesce(curr.d_plan_cd,fd.d_plan_cd)::char(2) as d_plan_cd
,coalesce(curr.d_status,fd.d_status)::char(1) as d_status
,coalesce(curr.d_mbrs_covered,fd.d_mbrs_covered)::char(1) as d_mbrs_covered
,' ' ::char(2) as d_cancel_rsn
,' ' ::char(1) as d_filler_30621
,' ' ::char(8) as d_facility_id
,' ' ::char(15) as d_filler_315_329
---------------------------------------------------------------
---- start life (CP) 20 columns 330 - 392 EMPLOYEE ONLY   -----
---------------------------------------------------------------
,coalesce(curr.cp_covcode,fd.cp_covcode) ::char(2) as cp_covcode
,coalesce(curr.cp_cov_start,fd.cp_cov_start) ::char(8) as cp_cov_start
,coalesce(curr.cp_cov_end,fd.cp_cov_end) ::char(8) as cp_cov_end
,coalesce(curr.cp_grp_nbr,fd.cp_grp_nbr) ::char(7) as cp_grp_nbr
,coalesce(curr.cp_sub_cd,fd.cp_sub_cd) ::char(4) as cp_sub_cd
,coalesce(curr.cp_branch,fd.cp_branch) ::char(4) as cp_branch
,' ' ::char(2) as cp_filler_363_364
,coalesce(curr.cp_status,fd.cp_status) ::char(1) as cp_status
,coalesce(curr.cp_mbrs_covered,fd.cp_mbrs_covered) ::char(1) AS cp_mbrs_covered
,' ' ::char(10) as cp_filler_367_376
,coalesce(curr.cp_annual_benefit_amt,fd.cp_annual_benefit_amt) ::char(8) as cp_annual_benefit_amt
,coalesce(curr.cp_salary_mode,fd.cp_salary_mode) ::char(1) as cp_salary_mode
,coalesce(curr.cp_salary_amount,fd.cp_salary_amount) ::char(7) as cp_salary_amount
---------------------------------------------------------------
---- start AD&D (AD) 21 columns 393 - 455 EMPLOYEE ONLY   -----
---------------------------------------------------------------
,coalesce(curr.ad_covcode,fd.ad_covcode) ::char(2) as ad_covcode
,coalesce(curr.ad_cov_start,fd.ad_cov_start) ::char(8) as ad_cov_start
,coalesce(curr.ad_cov_end,fd.ad_cov_end) ::char(8) as ad_cov_end
,coalesce(curr.ad_grp_nbr,fd.ad_grp_nbr) ::char(7) as ad_grp_nbr
,coalesce(curr.ad_sub_cd,fd.ad_sub_cd) ::char(4) as ad_sub_cd
,coalesce(curr.ad_branch,fd.ad_branch) ::char(4) as ad_branch
,' ' ::char(2) as ad_filler_426_427
,coalesce(curr.ad_status,fd.ad_status) ::char(1) as ad_status
,coalesce(curr.ad_mbrs_covered,fd.ad_mbrs_covered) ::char(1) AS ad_mbrs_covered
,' ' ::char(10) as ad_filler_430_439
,coalesce(curr.ad_annual_benefit_amt,fd.ad_annual_benefit_amt) ::char(8) as ad_annual_benefit_amt
,coalesce(curr.ad_salary_mode,fd.ad_salary_mode) ::char(1) as ad_salary_mode      
,coalesce(curr.ad_salary_amount,fd.ad_salary_amount) ::char(7) as ad_salary_amount   
---------------------------------------------------------------
---- start ltd (LT) 31 columns 456 - 518  EMPLOYEE ONLY   -----
---------------------------------------------------------------
,coalesce(curr.lt_covcode,fd.lt_covcode) ::char(2) as lt_covcode
,coalesce(curr.lt_cov_start,fd.lt_cov_start) ::char(8) as lt_cov_start
,coalesce(curr.lt_cov_end,fd.lt_cov_end) ::char(8) as lt_cov_end
,coalesce(curr.lt_grp_nbr,fd.lt_grp_nbr) ::char(7) as lt_grp_nbr
,coalesce(curr.lt_sub_cd,fd.lt_sub_cd) ::char(4) as lt_sub_cd
,coalesce(curr.lt_branch,fd.lt_branch) ::char(4) as lt_branch
,' ' ::char(2) as lt_filler_489_490
,coalesce(curr.lt_status,fd.lt_status) ::char(1) as lt_status
,coalesce(curr.lt_mbrs_covered,fd.lt_mbrs_covered) ::char(1) AS lt_mbrs_covered
,' ' ::char(10) as lt_filler_493_502
,coalesce(curr.lt_monthly_benefit_amt,fd.lt_monthly_benefit_amt) ::char(8) as lt_monthly_benefit_amt
,coalesce(curr.lt_salary_mode,fd.lt_salary_mode) ::char(1) as lt_salary_mode
,coalesce(curr.lt_salary_amount,fd.lt_salary_amount) ::char(7) as lt_salary_amount
---------------------------------------------------------------
---- start STD (AS) 30 columns 519 - 581  EMPLOYEE ONLY   -----
---------------------------------------------------------------
,coalesce(curr.as_covcode,fd.as_covcode) ::char(2) as as_covcode
,coalesce(curr.as_cov_start,fd.as_cov_start) ::char(8) as as_cov_start
,coalesce(curr.as_cov_end,fd.as_cov_end) ::char(8) as as_cov_end
,coalesce(curr.as_grp_nbr,fd.as_grp_nbr) ::char(7) as as_grp_nbr
,coalesce(curr.as_sub_cd,fd.as_sub_cd) ::char(4) as as_sub_cd
,coalesce(curr.as_branch,fd.as_branch) ::char(4) as as_branch
,' ' ::char(2) as as_filler_552_553
,coalesce(curr.as_status,fd.as_status) ::char(1) as as_status
,coalesce(curr.as_mbrs_covered,fd.as_mbrs_covered) ::char(1) AS as_mbrs_covered
,' ' ::char(10) as as_filler_556_565
,coalesce(curr.as_weekly_benefit_amt,fd.as_weekly_benefit_amt) ::char(8) as as_weekly_benefit_amt
,coalesce(curr.as_salary_mode,fd.as_salary_mode) ::char(1) as as_salary_mode
,coalesce(curr.as_salary_amount,fd.as_salary_amount) ::char(7) as as_salary_amount     
-------------------------------------------------------------------------   
...
----------------------------------------------------------------------------------            
---- start Supplemental Basic Life (OP) 21 columns 645 - 707 EMPLOYEE ONLY   -----
----------------------------------------------------------------------------------
,coalesce(curr.op_covcode,fd.op_covcode) ::char(2) as op_covcode
,coalesce(curr.op_cov_start,fd.op_cov_start) ::char(8) as op_cov_start
,coalesce(curr.op_cov_end,fd.op_cov_end) ::char(8) as op_cov_end
,coalesce(curr.op_grp_nbr,fd.op_grp_nbr) ::char(7) as op_grp_nbr
,coalesce(curr.op_sub_cd,fd.op_sub_cd) ::char(4) as op_sub_cd
,coalesce(curr.op_branch,fd.op_branch) ::char(4) as op_branch
,' ' ::char(2) as op_filler_678_679
,coalesce(curr.op_status,fd.op_status) ::char(1) as op_status
,coalesce(curr.op_mbrs_covered,fd.op_mbrs_covered) ::char(1) AS op_mbrs_covered
,' ' ::char(10) as op_filler_682_691
,coalesce(curr.op_annual_benefit_amt,fd.op_annual_benefit_amt) ::char(8) as op_annual_benefit_amt
,coalesce(curr.op_salary_mode,fd.op_salary_mode) ::char(1) as op_salary_mode
,coalesce(curr.op_salary_amount,fd.op_salary_amount) ::char(7) as op_salary_amount
-------------------------------------------------------------------------------            
---- start Supplemental Spouse Life (LZ) 2Z columns 708 - 770 SPOUSE ONLY -----
-------------------------------------------------------------------------------     
,coalesce(curr.lz_covcode,fd.lz_covcode) ::char(2) as lz_covcode
,coalesce(curr.lz_cov_start,fd.lz_cov_start) ::char(8) as lz_cov_start
,coalesce(curr.lz_cov_end,fd.lz_cov_end) ::char(8) as lz_cov_end
,coalesce(curr.lz_grp_nbr,fd.lz_grp_nbr) ::char(7) as lz_grp_nbr
,coalesce(curr.lz_sub_cd,fd.lz_sub_cd) ::char(4) as lz_sub_cd
,coalesce(curr.lz_branch,fd.lz_branch) ::char(4) as lz_branch
,' ' ::char(2) as lz_filler_741_742
,coalesce(curr.lz_status,fd.lz_status) ::char(1) as lz_status
,coalesce(curr.lz_mbrs_covered,fd.lz_mbrs_covered) ::char(1) AS lz_mbrs_covered
,' ' ::char(10) as lz_filler_745_754
,coalesce(curr.lz_annual_benefit_amt,fd.lz_annual_benefit_amt) ::char(8) as lz_annual_benefit_amt
,' ' ::char(8) as lz_filler_763_770
-----------------------------------------------------------------------------------            
---- start Supplemental Child Life (LF) 25 columns 771 - 833  CHILD(REN) ONLY -----
-----------------------------------------------------------------------------------  
,coalesce(curr.lf_covcode,fd.lf_covcode) ::char(2) as lf_covcode
,coalesce(curr.lf_cov_start,fd.lf_cov_start) ::char(8) as lf_cov_start
,coalesce(curr.lf_cov_end,fd.lf_cov_end) ::char(8) as lf_cov_end
,coalesce(curr.lf_grp_nbr,fd.lf_grp_nbr) ::char(7) as lf_grp_nbr
,coalesce(curr.lf_sub_cd,fd.lf_sub_cd) ::char(4) as lf_sub_cd
,coalesce(curr.lf_branch,fd.lf_branch) ::char(4) as lf_branch
,' ' ::char(2) as lf_filler_804_805
,coalesce(curr.lf_mbrs_covered,fd.lf_mbrs_covered) ::char(1) AS lf_mbrs_covered 
,' ' ::char(10) as lf_filler_808_817
,coalesce(curr.lf_annual_benefit_amt,fd.lf_annual_benefit_amt) ::char(8) as lf_annual_benefit_amt
,' ' ::char(8) as lf_filler_826_833
--------------------------------------------------------------------------------            
---- start Supplemental Basic AD&D (OD) 21 columns 834 - 896 EMPLOYEE ONLY -----
--------------------------------------------------------------------------------  
,coalesce(curr.od_covcode,fd.od_covcode) ::char(2) as od_covcode
,coalesce(curr.od_cov_start,fd.od_cov_start) ::char(8) as od_cov_start
,coalesce(curr.od_cov_end,fd.od_cov_end) ::char(8) as od_cov_end
,coalesce(curr.od_grp_nbr,fd.od_grp_nbr) ::char(7) as od_grp_nbr
,coalesce(curr.od_sub_cd,fd.od_sub_cd) ::char(4) as od_sub_cd
,coalesce(curr.od_branch,fd.od_branch) ::char(4) as od_branch
,' ' ::char(2) as od_filler_867_868
,coalesce(curr.od_status,fd.od_status) ::char(1) as od_status
,coalesce(curr.od_mbrs_covered,fd.od_mbrs_covered) ::char(1) AS od_mbrs_covered
,' ' ::char(10) as od_filler_871_880
,coalesce(curr.od_annual_benefit_amt,fd.od_annual_benefit_amt) ::char(8) as od_annual_benefit_amt
,coalesce(curr.od_salary_mode,fd.od_salary_mode) ::char(1) as od_salary_mode
,coalesce(curr.od_salary_amount,fd.od_salary_amount) ::char(7) as od_salary_amount 
-------------------------------------------------------------------------------            
---- start Supplemental Spouse AD&D (AE) 2Z columns 897 - 959 SPOUSE ONLY -----
-------------------------------------------------------------------------------  
,coalesce(curr.ae_covcode,fd.ae_covcode) ::char(2) as ae_covcode
,coalesce(curr.ae_cov_start,fd.ae_cov_start) ::char(8) as ae_cov_start
,coalesce(curr.ae_cov_end,fd.ae_cov_end) ::char(8) as ae_cov_end
,coalesce(curr.ae_grp_nbr,fd.ae_grp_nbr) ::char(7) as ae_grp_nbr
,coalesce(curr.ae_sub_cd,fd.ae_sub_cd) ::char(4) as ae_sub_cd
,coalesce(curr.ae_branch,fd.ae_branch) ::char(4) as ae_branch
,' ' ::char(2) as ae_filler_930_931
,coalesce(curr.ae_status,fd.ae_status) ::char(1) as ae_status
,coalesce(curr.ae_mbrs_covered,fd.ae_mbrs_covered) ::char(1) AS ae_mbrs_covered
,' ' ::char(10) as ae_filler_934_943
,coalesce(curr.ae_annual_benefit_amt,fd.ae_annual_benefit_amt) ::char(8) as ae_annual_benefit_amt
,' ' ::char(8) as ae_filler_952_959
-----------------------------------------------------------------------------------            
---- start Supplemental Child AD&D (AT) 25 columns 960 - 1022 CHILD(REN) ONLY -----
-----------------------------------------------------------------------------------  
,coalesce(curr.at_covcode,fd.at_covcode) ::char(2) as at_covcode
,coalesce(curr.at_cov_start,fd.at_cov_start) ::char(8) as at_cov_start
,coalesce(curr.at_cov_end,fd.at_cov_end) ::char(8) as at_cov_end
,coalesce(curr.at_grp_nbr,fd.at_grp_nbr) ::char(7) as at_grp_nbr
,coalesce(curr.at_sub_cd,fd.at_sub_cd) ::char(4) as at_sub_cd
,coalesce(curr.at_branch,fd.at_branch) ::char(4) as at_branch
,' ' ::char(2) as at_filler_993_994
,coalesce(curr.at_status,fd.at_status) ::char(1) as at_status
,coalesce(curr.at_mbrs_covered,fd.at_mbrs_covered) ::char(1) AS at_mbrs_covered
,' ' ::char(10) as at_filler_997_1006
,coalesce(curr.at_annual_benefit_amt,fd.at_annual_benefit_amt) ::char(8) as at_annual_benefit_amt
...
---------------------------------------------------------------------------------            
---- start Vision (VV) 14 columns 1279 - 1340 Based on Coverage Description -----
---------------------------------------------------------------------------------  
,coalesce(curr.vv_covcode,fd.vv_covcode) ::char(2) as vv_covcode
,coalesce(curr.vv_cov_start,fd.vv_cov_start) ::char(8) as vv_cov_start
,coalesce(curr.vv_cov_end,fd.vv_cov_end) ::char(8) as vv_cov_end
,coalesce(curr.vv_grp_nbr,fd.vv_grp_nbr) ::char(7) as vv_grp_nbr
,coalesce(curr.vv_sub_cd,fd.vv_sub_cd) ::char(4) as vv_sub_cd
,coalesce(curr.vv_branch,fd.vv_branch) ::char(4) as vv_branch
,' ' ::char(2) as vv_filler_1312_1313
,coalesce(curr.vv_status,fd.vv_status) ::char(1) as vv_status
,coalesce(curr.vv_mbrs_covered,fd.vv_mbrs_covered) ::char(1) AS vv_mbrs_covered
,' ' ::char(2) as vv_cancel_rsn
,' ' ::char(23) as vv_filler_1318_1340
,coalesce(curr.dept_code,fd.dept_code)::char(10) as dept_code
...
,elu.lastupdatets
,'0' AS dependentid
,'FUTURE DATED ACTIVE EE'::varchar(30) as qsource
,'E' ::char(1) as transcode
,'5923955' ::char(7) as custnbr 
,lpad(pi.identity,11,'0') ::char(11) as enbr
,' ' ::char(11) as filler_20_30
...
join person_bene_election pbe
 ...
 and pbe.enddate > current_date   
 and pbe.benefitsubclass in ('20','21','11','30','31','14','25','2Z') 
 and pbe.effectivedate < pbe.enddate and pbe.effectivedate > current_date and current_timestamp between pbe.createts and pbe.endts
--------------------------------------------------------------------------
---- start dental 11 columns 267 - 329 Based on Coverage Description -----
--------------------------------------------------------------------------
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '11' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbednt on pbednt.personid = pbe.personid and pbednt.rank = 1   
...
---------------------------------------------------------------------------  
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '21' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbesupe on pbesupe.personid = pbe.personid and pbesupe.rank = 1  
...
----------------------------------------------------------
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '31' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date 
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbeltd on pbeltd.personid = pbe.personid and pbeltd.rank = 1  
...
----------------------------------------------------------
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '30' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbestd on pbestd.personid = pbe.personid and pbestd.rank = 1  
...
------------------------------------------------------------------------------  
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '25' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbesupc on pbesupc.personid = pbe.personid and pbesupc.rank = 1   
--------------------------------------------------------------------------            
---- start Supplemental Spouse Life 2Z columns 708 - 770 SPOUSE ONLY -----
--------------------------------------------------------------------------  
...
--------------------------------------------------------------------------  
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '2Z' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date 
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbesups on pbesups.personid = pbe.personid and pbesups.rank = 1   
----------------------------------------------------------------------------            
---- start Vision 14 columns 1279 - 1340 Based on Coverage Description -----
----------------------------------------------------------------------------  
left join (select personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount, max(effectivedate) as effectivedate, max(enddate) as enddate,RANK() OVER (PARTITIon BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
             from person_bene_election where benefitsubclass = '14' and benefitelection = 'E' and selectedoption = 'Y' and current_timestamp between createts and endts and effectivedate < enddate and effectivedate >= current_date
            group by personid, benefitelection, benefitcoverageid, benefitsubclass, benefitplanid, personbeneelectionpid, coverageamount) pbevsn on pbevsn.personid = pbe.personid and pbevsn.rank = 1                       
...
where pi.identitytype = 'SSN'
  and current_timestamp between pi.createts and pi.endts
  and pe.emplstatus NOT IN ('T','R')
  and pbe.effectivedate - interval '14 days' <= current_date
  )fd on fd.personid = curr.personid
