...
join (select ppdx.personid, ppdx.group_key
	...
	--MISC hours & pay for pay period - M
		, sum(case when ppdx.etv_id IN ('E71','EA6','EA8','EAI','EB5','EC5','EBC','EB7','EB8') then ppdx.etype_hours else 0 end) as hoursM
	 	, sum(case when ppdx.etv_id IN ('E71','EA6','EA8','EAI','EB5','EC5','EBC','EB7','EB8') then ppdx.etv_amount else 0 end) as grosspayM
		from perschkdt 
