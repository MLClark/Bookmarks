...
LEFT JOIN 
(select lp.lookupid, value1 as GroupCode, value2 as PlanID, lp.VALUE3 ::date as plan_year_start_date, lp.VALUE4 ::date as plan_year_end_date
   from edi.lookup lp
