...
where pbeden.selectedoption  = 'Y' and pbeden.benefitsubclass in ('11') and current_timestamp between pbeden.createts and pbeden.endts --and pbeden.personid = '2320'
  and ((pbeden.benefitelection in ('E') and 
  ((current_date between pbeden.effectivedate and pbeden.enddate) or (pbeden.effectivedate > current_date and pbeden.effectivedate < pbeden.enddate and pbeden.effectivedate between cppy.planyearstart and cppy.planyearend)))
   OR 
   (pbeden.benefitelection in ('T','W') 
   and pbeden.effectivedate < pbeden.enddate and pbeden.effectivedate between cppy.planyearstart and cppy.planyearend and pbeden.personid in (select personid from person_bene_election where benefitsubclass in ('11') and benefitelection = 'E' and selectedoption = 'Y' 
                        and current_timestamp between createts and endts and effectivedate < enddate and current_date - interval '1 day' between deductionstartdate and planyearenddate)))
