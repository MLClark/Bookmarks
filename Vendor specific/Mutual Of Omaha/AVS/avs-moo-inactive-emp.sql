...
),'YYYYMMDD') ::char(8) as emp_eff_date -- bring forward all effective date starting at 317 to reset date 01/01/2018 do not alter dates after reset date
...
,pbe2si.effectivedate
,pbe2ss.effectivedate
,pl.effectivedate),'yyyymmdd')::char(8) as location_effective_date -- effectivedate of the subscribers location
...
,pbe2si.effectivedate
,pbe2ss.effectivedate
,pc.effectivedate),'YYYYMMDD')::char(8) as basic_sal_eff_date
...
,pbe2si.effectivedate
,pbe2ss.effectivedate
,pv.effectivedate),'yyyymmdd') ::char(8) as smoker_status_effective_date
...
left join person_locations pl 
  on pl.personid = maxloc.personid
 and pl.perlocpid = maxloc.perlocpid
