...
,case when pbedent.benefitsubclass in ('11') and depdental.benefitcoveragedesc = 'Family' then 'A' 
      when pbedent.benefitsubclass in ('11') and depdental.benefitcoveragedesc = 'Employee + Spouse' then 'B' 
      when pbedent.benefitsubclass in ('11') and depdental.benefitcoveragedesc = 'Employee Only' then 'C' 
      when pbedent.benefitsubclass in ('11') and depdental.benefitcoveragedesc = 'Employee + Children' then 'D' 
...
join person_dependent_relationship pdr
 ...
 and pdr.dependentrelationship in ('D','S','C','DP','SP')
...
join (select distinct de.personid, de.dependentid, de.benefitsubclass, de.effectivedate, de.selectedoption, pdr.dependentrelationship, bcd.benefitcoveragedesc
           ...
           )depdental on depdental.personid = pbe.personid 
