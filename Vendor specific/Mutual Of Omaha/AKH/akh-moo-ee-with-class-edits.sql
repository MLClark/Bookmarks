...
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then '1' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then '1' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then '1' 
      else ' ' end ::char(1) as product_category_1
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then to_char(pbeblife.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then to_char(pbeblife.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then to_char(pbeblife.effectivedate,'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_1
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'E'  then 'EN' 
      else '  ' end ::char(2) as elig_event_1
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'LTL0NCFLAT' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'LTL0NCFLAT' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'LTL0NCFLAT' 
      else ' ' end ::char(10) as plan_id_1
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'C' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'C' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'C' 
...
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'a' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'a' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'a' 
      else ' ' end ::char(1) as product_category_a
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then to_char(pbeadd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then to_char(pbeadd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then to_char(pbeadd.effectivedate,'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_a
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'T'  then 'TM'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'T'  then 'TM'
      when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'E'  then 'EN' 
      else '  ' end ::char(2) as elig_event_a
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'ATA0NCFLAT' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'ATA0NCFLAT' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'ATA0NCFLAT' 
      else ' ' end ::char(10) as plan_id_a
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'C' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'C' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'C' 
      else ' ' end ::char(1) as emp_only_a

-- BASIC STD SEGMENT (32) 920 - 942
/*
The Basic STD benefits should only be populated on Employee records in Class A003 & A004 only
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' then 'A001'
      when pu.payunitdesc = 'AKH00' then 'A002'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' then 'A003'
      when pu.payunitdesc = 'AKH05' then 'A004'
...
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'S' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'S' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'S' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'S' 
      else ' ' end ::char(1) as product_category_S
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate)::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate)::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate)::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate)::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_s
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      else '  ' end ::char(2) as elig_event_s
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'STS00NCSAL' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'STS00NCSAL' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'STS00NCSAL' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'STS00NCSAL' 
      else ' ' end ::char(10) as plan_id_s
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'C' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'C'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'C' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'C' 
...
/*
The Basic LTD benefits should only be populated on Employee records in Class A003 & A004 only
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' then 'A001'
      when pu.payunitdesc = 'AKH00' then 'A002'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' then 'A003'
      when pu.payunitdesc = 'AKH05' then 'A004'
...
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'T' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'T' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'T' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'T' 
      else ' ' end ::char(1) as product_category_t
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD')
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD')
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.effectivedate::date < '2018-01-01' then date_part('year',current_date)||'0101'
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD')
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD')
      else ' ' end ::char(8) as pc_effective_date_t
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'T'  then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      else ' ' end ::char(2) as elig_event_t
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'TTT00NCSAL' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'TTT00NCSAL' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'TTT00NCSAL' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'TTT00NCSAL' 
      else ' ' end ::char(10) as plan_id_t
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'C' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'C' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'C' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'C' 
...
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then to_char(pbeblife.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then to_char(pbeblife.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then to_char(pbeblife.effectivedate,'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_1
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') then 'TM' 
      when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeblife.benefitsubclass in ('20') and pbeblife.benefitelection = 'E'  then 'EN' 
      else '  ' end ::char(2) as elig_event_1
...
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then to_char(pbeadd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then to_char(pbeadd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then to_char(pbeadd.effectivedate,'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_a
,case when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') then 'TM' 
      when pu.payunitdesc = 'AKH00' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y' and pbeadd.benefitsubclass in ('22') and pbeadd.benefitelection = 'E'  then 'EN' 
      else '  ' end ::char(2) as elig_event_a
...
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then to_char(coalesce(pbestaffstd.effectivedate,pbeerstd.effectivedate),'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_s
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and coalesce(pbestaffstd.benefitsubclass,pbeerstd.benefitsubclass) in ('30','32') and coalesce(pbestaffstd.benefitelection,pbeerstd.benefitelection) = 'E'  then 'EN' 
      else '  ' end ::char(2) as elig_event_s
...
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD') 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then to_char(pbeltd.effectivedate,'YYYYMMDD') 
      else ' ' end ::char(8) as pc_effective_date_t
,case when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag <> 'Y' and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'TM' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') then 'TM' 
      when pu.payunitdesc = 'AKH05' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      when pu.payunitdesc = 'AKH15' and mef.medical_enrolled_flag = 'Y'  and pbeltd.benefitsubclass in ('31') and pbeltd.benefitelection = 'E'  then 'EN' 
      else ' ' end ::char(2) as elig_event_t
