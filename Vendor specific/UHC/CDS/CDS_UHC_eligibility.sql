...
,case when pbe.effectivedate::date >= '2020-10-01' then to_char(pbe.effectivedate,'YYYYMMDD')    
      when pbe.effectivedate::date <  '2020-10-01' then '20201001' end ::char(8) as mbr_orig_eff_date --dt23
...
,case when pbe.effectivedate::date >= '2020-10-01' then to_char(pbe.effectivedate,'YYYYMMDD')    
      when pbe.effectivedate::date <  '2020-10-01' then '20201001' end ::char(8) as plan_coverage_eff_date --dt40
