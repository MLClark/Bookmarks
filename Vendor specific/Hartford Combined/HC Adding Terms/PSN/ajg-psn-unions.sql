...
-- active emp active dependents
 pi.personid
,'active emp active dep' ::varchar(30) as qsource
,'1' ::char(2) as sortseq
,pe.emplstatus
,'PSN'::char(3) AS recordType
,'HAR'::char(5) AS client 
...
union
select distinct
---- termed ee followed by termed ee deps
 pi.personid
...
,' ' ::char(1) AS cobra
,to_char(coalesce(pe.empllasthiredate,PE.emplhiredate),'MM/DD/YYYY') ::char(10) AS effectivedate
,to_char(de.enddate,'mm/dd/yyyy') ::char(10) AS termdate
,'T' ::char(1) AS termCode
,' ' ::char(8)  AS unapplied
,to_char(current_date,'mm/dd/yyyy') ::char(10) AS maintDate
,' ' ::char(5)  AS ccExpDate
,' ' ::char(4)  AS ccCVV2
