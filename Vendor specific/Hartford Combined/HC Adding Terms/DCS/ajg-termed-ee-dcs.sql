...
JOIN person_bene_election pbe 
 ...
 and pbe.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts 
                         and benefitsubclass in ('30','31') and benefitelection = 'E' and selectedoption = 'Y')  
--- std   
left JOIN person_bene_election pbestd
 ...
 and pbestd.benefitelection in ('T','E')
...
left JOIN person_bene_election pbeltd
 ...
 and pbeltd.benefitelection in ('T','E') 

join (select personid, max(positionid) as positionid
        from pers_pos
       where persposrel = 'Occupies'
         --and current_date between effectivedate and enddate
         and current_timestamp between createts and endts
          group by 1) as maxpos on maxpos.personid = pbe.personid

JOIN pers_pos pp 
  ON pp.personid = maxpos.personid 
 AND pp.persposrel = 'Occupies'::bpchar 
 and pp.positionid = maxpos.positionid
