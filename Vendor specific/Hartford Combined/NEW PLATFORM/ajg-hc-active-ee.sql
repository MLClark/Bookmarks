select distinct
 pi.personid
,pc.frequencycode
,'486 Active EE' ::varchar(30) as sourceseq
--------------------------------------------------------------
...
,case when pc.frequencycode = 'H' then '1' 
      when pc.frequencycode = 'A' then '2' end ::char(30) as csf_field1_value
-----------------------------------------
