select distinct
 pi.personid
,pc.frequencycode
,'483 Active EE' ::varchar(30) as sourceseq
--------------------------------------------------------------
...
select distinct
 pi.personid
,pc.frequencycode
,'54 Active EE SP' ::varchar(30) as sourceseq
--------------------------------------------------------------
----- Employee or Dependent Personal Information Section -----  
--------------------------------------------------------------
,'~PII~' ::char(5) as section_code_pii
...
------------------------------------
,'~VCI~'::char(5) as section_code_vci
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') then to_char(pbeci.effectivedate,'YYYYMMDD') else null end ::char(8) as vci_cov_effdate
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and pbeci.benefitelection = 'T' then to_char(pbeci.enddate,'YYYYMMDD')
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and pe.emplstatus = 'T' then to_char(pe.effectivedate,'YYYYMMDD')
      else null end ::char(8) as vci_cov_term_date
,null as vci_cov_term_rsn_code
,null as vci_cov_term_desc
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and pbeci.benefitplanid in ('120', '126', '114') Then '10000'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and pbeci.benefitplanid in ('129', '123', '132') Then '20000'
      else null End ::char(10) as vci_bene_amt
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and bcdci.benefitcoveragedesc = 'Employee Only' then '1'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and bcdci.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and bcdci.benefitcoveragedesc = 'Family' then '2'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and bcdci.benefitcoveragedesc = 'Employee + Children' then '4'  
      else null end ::char(1) AS vci_coverage_tier  
,case when pbeci.benefitsubclass = '1W' then '1' else null end ::char(1) as vci_plan_number
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and lc.locationid in ('1') then '7'  --- corporate
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and lc.locationid in ('2') then '9'  --- elgin
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and lc.locationid in ('3') then '11' --- germantown tooling
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and lc.locationid in ('4') then '12' --- lake forrest
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') and lc.locationid in ('6') then '10' --- portland
      else null end ::char(5) as vci_employee_group_id
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('2','5') then '1' else null end ::char(1) as vci_employee_class
------------------------------
----- Accident Section   ----- 
----- Section Code ~VAC~ -----
------------------------------
...
,'45 Active EE DEP' ::varchar(30) as sourceseq
--------------------------------------------------------------
----- Employee or Dependent Personal Information Section -----  
--------------------------------------------------------------
,'~PII~' ::char(5) as section_code_pii
...
-----------------------------------------
,'~NST~'::char(5) as section_code_nst
,case when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') then to_char(pbestd.effectivedate,'YYYYMMDD') else null end ::char(8) as nst_cov_effdate
,case when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pbestd.benefitelection = 'T' then to_char(pbestd.enddate,'YYYYMMDD')
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pe.emplstatus = 'T' then to_char(pe.effectivedate,'YYYYMMDD')
      else null end ::char(8) as nst_cov_term_date
,' ' ::char(1) as nst_std_covered_salary
/*
"60 - for Salaried
...
-- I believe the Voluntary STD plan is the Buyup plan and the ER plan is the Core plan, so STD Coverage Plan Option should be Buyup for those with the Voluntary plan
,case when pbestd.benefitsubclass in ('30') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'H' and pbestd.benefitplanid = '285' then 'Buyup'
      when pbestd.benefitsubclass in ('30') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'H' and pbestd.benefitplanid = '111' then 'Core'
      when pbestd.benefitsubclass in ('3Y') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'H' and pbestd.benefitplanid in ('291','288') then 'Core'
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'A' then '60'else null end ::varchar(10) as nst_std_cvg_plan_option
,' ' ::char(1) as nst_std_req_cvg_plan_option
/*
2/20/19 chg based on Mauricio's email:
Based on Pay Unit & plan option:
...
,pbestd.benefitplanid
,pc.frequencycode
,case when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('00') and pbestd.benefitplanid = '291' then '1'     ---1 - for AJG00 w/plan id 291 - STD Salaried
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('01') and pbestd.benefitplanid <> '285' then '6'         ---6 - for AJG01 W/O plan id 285 (core only) *
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('01') and pbestd.benefitplanid = '285' then '30'              --30 - for AJG01 w/plan id 285 STD Hrly Vol (Buyup plan)
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('05','06') and pbestd.benefitplanid <> '285' then '24'   --24 - for AJG05 & 06 W/O plan id 285 (core only or salary) *
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('06') and pbestd.benefitplanid = '285' then '29'              --29 - for AJG06 w/plan id 285 STD Hrly Vol (Buyup plan)
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('15','16') and pbestd.benefitplanid <> '285' then '26'        --26 - for AJG15 & 16 W/O  plan id 285 (core only or salary) *
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('16') and pbestd.benefitplanid = '285' then '31'              --31 - for AJG16 w/plan id 285 STD Hrly Vol (Buyup plan)
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('20') and pbestd.benefitplanid <> '285' then '3'              ---3 - for AJG20 W/O plan id 285 (core only or salary) *
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid in ('20') and pbestd.benefitplanid = '285' then '27'              --27 - for AJG20 w/plan id 285 STD Hrly Vol (Buyup plan)
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pu.payunitxid not in ('00') and pbestd.benefitplanid = '291' then '1' --- not accounted for in Lori's notes
      else null end ::char(2) as nst_ee_group_id
...
5 - for Hourly w/ plan id 285 (Buyup plan)
*/
,case when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'A' then '3'
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'H' and pbestd.benefitplanid =  '285' then '4' 
      when pbestd.benefitsubclass in ('30','3Y') and pbestd.benefitcoverageid in ('3','5') and pc.frequencycode = 'H' and pbestd.benefitplanid <> '285' then '5' else null end ::char(1) as nst_ee_class_code 
----------------------------------------
----- Long Term Disability Section -----
----- Section Code ~LTD~           -----
----------------------------------------
,'~LTD~'::char(5) as section_code_ltd
,case when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') then to_char(pbeltd.effectivedate,'YYYYMMDD') else null end ::char(8) as ltd_cov_effdate
,case when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pbeltd.benefitelection = 'T' then to_char(pbeltd.enddate,'YYYYMMDD')
      when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pe.emplstatus = 'T' then to_char(pe.effectivedate,'YYYYMMDD')
      else null end ::char(8) as ltd_cov_term_date
,null as ltd_cov_term_rsn_code
,null as ltd_cov_term_desc    
,null as ltd_covered_salary
,case when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') then '60' else null end ::char(2) as ltd_coverage_plan_option
,null as ltd_req_cvg_plan_option
/*
"Based on Pay Unit:
1 - for AJG00 - 01
...
5 - for AJG10
*/
,case when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pu.payunitxid in ('00','01','25') then '1'
      when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pu.payunitxid in ('05','06') then '2'
      when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pu.payunitxid in ('20') then '3'
      when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pu.payunitxid in ('15','16') then '4' 
      when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pu.payunitxid in ('10','11') then '5' else null end ::char(1) as ltd_ee_group_id
,case when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pc.frequencycode = 'A' then '1'
      when pbeltd.benefitsubclass in ('31') and pbeltd.benefitcoverageid in ('3','5') and pc.frequencycode = 'H' then '2'else null end ::char(1) as ltd_employee_class_code
------------------------------------
----- Critical Illness Section ----- 
----- Section Code ~VCI~       -----
------------------------------------
,'~VCI~'::char(5) as section_code_vci
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') then to_char(pbeci.effectivedate,'YYYYMMDD') else null end ::char(8) as vci_cov_effdate
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and pbeci.benefitelection = 'T' then to_char(pbeci.enddate,'YYYYMMDD')
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and pe.emplstatus = 'T' then to_char(pe.effectivedate,'YYYYMMDD')
      else null end ::char(8) as vci_cov_term_date
,null as vci_cov_term_rsn_code
,null as vci_cov_term_desc
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and pbeci.benefitplanid in ('120', '126', '114') Then '10000'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and pbeci.benefitplanid in ('129', '123', '132') Then '20000'
      else null End ::char(10) as vci_bene_amt
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and bcdci.benefitcoveragedesc = 'Employee Only' then '1'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and bcdci.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and bcdci.benefitcoveragedesc = 'Family' then '2'
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and bcdci.benefitcoveragedesc = 'Employee + Children' then '4'  
      else null end ::char(1) AS vci_coverage_tier  
,case when pbeci.benefitsubclass = '1W' then '1' else null end ::char(1) as vci_plan_number
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and lc.locationid in ('1') then '7'  --- corporate
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and lc.locationid in ('2') then '9'  --- elgin
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and lc.locationid in ('3') then '11' --- germantown tooling
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and lc.locationid in ('4') then '12' --- lake forrest
      when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') and lc.locationid in ('6') then '10' --- portland
      else null end ::char(5) as vci_employee_group_id
,case when pbeci.benefitsubclass = '1W' and pbeci.benefitcoverageid in ('3','5') then '1' else null end ::char(1) as vci_employee_class
------------------------------
----- Accident Section   ----- 
----- Section Code ~VAC~ -----
------------------------------
,'~VAC~' ::char(5) as section_code_vac
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') then to_char(pbeac.effectivedate,'YYYYMMDD') else null end ::char(8) as vac_cov_effdate
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and pbeac.benefitelection = 'T' then to_char(pbeac.enddate,'YYYYMMDD')
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and pe.emplstatus = 'T' then to_char(pe.effectivedate,'YYYYMMDD')
      else null end ::char(8) as vac_cov_term_date
,null as vac_cov_term_rsn_code
,null as vac_cov_term_desc
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and bcdac.benefitcoveragedesc = 'Employee Only' then '1'
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and bcdac.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and bcdac.benefitcoveragedesc = 'Family' then '2'
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and bcdac.benefitcoveragedesc = 'Employee + Children' then '4'  
      else null end ::char(1) AS vac_coverage_tier  
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and pbeac.benefitplanid = '135' then 'Plan 1'
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and pbeac.benefitplanid = '138' then 'Plan 2'
      else null end ::char(6) as vac_plan_option
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') then '1' else null end ::char(1) as vac_plan_number
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and lc.locationid in ('1') then '13' --- corporate
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and lc.locationid in ('2') then '15' --- elgin
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and lc.locationid in ('3') then '17' --- germantown tooling
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and lc.locationid in ('4') then '18' --- lake forrest
      when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') and lc.locationid in ('6') then '16' --- portland
      else null end ::char(5) as vac_employee_group_id
,case when pbeac.benefitsubclass = '13' and pbeac.benefitcoverageid in ('3','5') then '1' else null end ::char(1) as vac_employee_class
--------------------------------------
----- Hospital Indemnity Section ----- 
----- Section Code ~HIP~         -----
--------------------------------------
...
,pbehi.benefitplanid
,pu.payunitxid
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') then to_char(pbehi.effectivedate,'YYYYMMDD') else null end ::char(8) as hip_cov_effdate
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pbehi.benefitelection = 'T' then to_char(pbehi.enddate,'YYYYMMDD')
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pe.emplstatus = 'T' then to_char(pe.effectivedate,'YYYYMMDD')
      else null end ::char(8) as hip_cov_term_date
,null as hip_cov_term_rsn_code
,null as hip_cov_term_desc
...
4 - EE + Children
*/
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and bcdhi.benefitcoveragedesc = 'Employee Only' then '1'
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and bcdhi.benefitcoveragedesc = 'Employee + Spouse' then '3'
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and bcdhi.benefitcoveragedesc = 'Family' then '2'
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and bcdhi.benefitcoveragedesc = 'Employee + Children' then '4'  
      else null end ::char(1) AS hip_coverage_tier  
...
Mid = Plan 2
*/      
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pbehi.benefitplanid = '279' then 'Plan 1'
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pbehi.benefitplanid = '282' then 'Plan 2'
      else null end ::char(6) as hip_plan_option
/*
3/4/19 chg based on Mauricio's email:
1 - for All
*/      
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') then '1' else null end ::char(1) as hip_plan_number
...
23 - for AJG10-11
*/      
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pu.payunitxid in ('00','01') then '19'  
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pu.payunitxid in ('05','06') then '20' 
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pu.payunitxid in ('20') then '21'  
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pu.payunitxid in ('15','16') then '22'  
      when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') and pu.payunitxid in ('10','11') then '23'  
      else null end ::char(5) as hip_employee_group_id
      
,case when pbehi.benefitsubclass = '1Hosp' and pbehi.benefitcoverageid in ('3','5') then '1' else null end ::char(1) as hip_employee_class
...
select distinct
 pi.personid
,pc.frequencycode
,'114 TERMED EE' ::varchar(30) as sourceseq
--------------------------------------------------------------
----- Employee or Dependent Personal Information Section -----  
--------------------------------------------------------------
,'~PII~' ::char(5) as section_code_pii
...
select distinct
 pi.personid
,pc.frequencycode
,'10 TERMED EE DEP' ::varchar(30) as sourceseq
--------------------------------------------------------------
----- Employee or Dependent Personal Information Section -----  
--------------------------------------------------------------
,'~PII~' ::char(5) as section_code_pii
...
JOIN person_bene_election pbe 
 ...
 and pbe.effectivedate < pe.effectivedate
 and pbe.enddate < '2199-12-30'
 ---and date_part('year',pbe.deductionstartdate) >= date_part('year',current_date)  -- can't exclude 2018 - many benefits are still active
 and pbe.personid in (select distinct personid from person_bene_election where current_timestamp between createts and endts and effectivedate < enddate
                         and benefitsubclass in ('1W','13','30','3Y','31','1Hosp') and benefitelection = 'E' and selectedoption = 'Y')  
--------------------- 
----- 10KCritNT -----
...
select distinct
 pi.personid
,pc.frequencycode
,'2 Active EE Termed Dep' ::varchar(30) as sourceseq
--------------------------------------------------------------
----- Employee or Dependent Personal Information Section -----  
--------------------------------------------------------------
,'~PII~' ::char(5) as section_code_pii
...
left join person_vitals pv
 ...
 -- select * from person_maritalstatus where personid = '10254';
...
where pi.identitytype = 'SSN'
  and current_date between pi.createts and pi.endts 
  and pe.emplstatus in ('A','L')
  order by personid, trans_code desc, nst_std_cvg_plan_option
