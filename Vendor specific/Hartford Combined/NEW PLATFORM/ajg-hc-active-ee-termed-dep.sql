...
-- select * from benefit_plan_desc where benefitsubclass in ('30','3Y') and current_date between effectivedate and enddate and current_timestamp between createts and endts
...
5 - for AJG10-11
*/
,case when pbestd.benefitsubclass in ('30','3Y') and pu.payunitxid in ('00','01','25') then '1'
      ...
      when pbestd.benefitsubclass in ('30','3Y') and pu.payunitxid in ('15','16') then '4' 
      when pbestd.benefitsubclass in ('30','3Y') and pu.payunitxid in ('10','11') then '5' else null end ::char(1) as nst_ee_group_id
      
,case when pbestd.benefitsubclass in ('30','3Y') and pc.frequencycode = 'A' then '1'
      when pbestd.benefitsubclass in ('30','3Y') and pc.frequencycode = 'H' then '2'else null end ::char(1) as nst_ee_class_code 
----------------------------------------
