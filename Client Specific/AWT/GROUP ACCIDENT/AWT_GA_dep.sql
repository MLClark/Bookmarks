...
,case when piDep.identitytype = 'SSN' then coalesce(replace(piDep.identity,'-',''),'000000000') else '000000000' end ::char(9) as person_ssn
...
join person_identity piDep
 ...
 and piDep.identitytype in ('SSN', 'BID')
