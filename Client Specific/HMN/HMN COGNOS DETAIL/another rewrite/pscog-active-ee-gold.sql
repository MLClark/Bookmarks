...
,'1500 ACTIVE EES' ::CHAR(20) as sourceseq
...
,to_char(cast(date_part('year',age(current_date,pe.emplhiredate)) + (date_part('month',age(current_date,pe.emplhiredate)) * .10) as dec (18,2)),'00.0')
