...
,'14 pc, pe, pp changes' ::CHAR(20) as sourceseq
...
,CASE WHEN pc.frequencycode = 'A' and pc.compamount IS NOT NULL then coalesce(to_char(trunc (sdrate.shift_dif_amt / ((pc.compamount/2080) * pp.scheduledhours)*.10,4),'99D9999'),'00.0000')  
      ...
      else '0.0000' END AS f17_O12_shift_differential_rate             
,to_char(pc.compamount,'00000000d00') ::char(12) as f18_o13_ee_annual_salary 
,to_char(round(vpcpira.percent_in_range,4),'0d0000') as f19_o14_pct_in_range
...
,to_char(pc.increaseamount,'00000009d00') ::char(12) as f22_o19_comp_change_amount
,pc.compevent as f23_o20_cognos_comp_code
,to_char((pc.compamount - pc.increaseamount),'00000000d00')::char(12) as f24_o21_prev_annual_salary  
...
,to_char(coalesce(dpc1.current_dedn_amount * -2,dpc.etv_amount * -1,0),'00000009d00') ::char(12) as f47_o22_dep_care_monthly_ded_amt
,to_char(coalesce(med1.current_dedn_amount * -2,med.etv_amount * -1,0),'00000009d00') ::char(12) as f48_o37_medical_monthly_ded_amt
,to_char(coalesce(dnt1.current_dedn_amount * -2,dnt.etv_amount * -1,0),'00000009d00') ::char(12) as f49_o38_dental_monthly_ded_amt
,to_char(coalesce(fsa1.current_dedn_amount * -2,fsa.etv_amount * -1,0),'00000009d00') ::char(12) as f50_o39_fsa_monthly_ded_amt
,to_char(coalesce(vsn1.current_dedn_amount * -2,vsn.etv_amount * -1,0),'00000009d00') ::char(12) as f51_o42_vision_monthly_ded_amt
,to_char(coalesce(hsa1.current_dedn_amount * -2,hsa.etv_amount * -1,0),'00000009d00') ::char(12) as f52_o43_hsa_monthly_ded_amt
,to_char(coalesce(hcu1.current_dedn_amount * -2,hcu.etv_amount * -1,0),'00000009d00') ::char(12) as f53_o44_hsa_cu_monthly_ded_amt
