...
,'1497 ACTIVE EES' ::CHAR(20) as sourceseq
...
,to_char(coalesce(TRUNC(ytdfica.fica -((ytdAb.ALL_bonus * .0620)+(ytdAb.ALL_bonus * .0145)),2),ytdfica.fica,0),'00000009d00') as f41_o25_ytd_fica_less_ytd_fica_bonus_fica_sev

,case when occc.orgcode  = '515110' then 'Y' else 'N' end as f42_o30_sev_ind

,to_char(ytdsev.severance_pay,'00000009d00') as f43_o40_ytd_cognos_sev_amt 
,to_char(TRUNC((ytdsev.severance_pay * .0620)+(ytdsev.severance_pay * .0145),2),'00000009d00')  as f44_o41_ytd_fica_on_sev_pay
