...
join pers_pos pp 
 ...
 and pp.effectivedate <= '2018-03-31'
...
left join 
      (select individual_key, etv_id, sum(etv_amount) as etv_amount
        ...
        where etv_id = 'VBB'
          ...
          and date_part('month',check_date) = '03'
          group by 1,2
      ) dpc
...
left join 
      (select individual_key, current_dedn_amount, etv_id
        ...
        where etv_id = 'VBB'
          ...
          and date_part('month',last_updt_dt) = '03'
      ) dpc1
...
where pi.identitytype = 'SSN'
  ...
  and (pe.effectivedate <= '2018-03-31' 
   or  pp.effectivedate <= '2018-03-31'
   or  pc.effectivedate <= '2018-03-31')
  order by 1