...
select * from pspay_input_transaction where transaction_originate like 'HMN_%' and individual_key = 'HMN00000022136';
delete from pspay_input_transaction where transaction_originate like 'HMN Life%';
select * from person_user_field_vals where ufid = '8';
select effectivedate from person_user_field_vals group by 1;
