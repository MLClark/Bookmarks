...
--		left(sp.stateprovincename,20)::char(20) as state,
		...
		left(ocDept.organizationdesc, 30) as Department,
		left(ocDept.orgcode, 4) as DeptOrgCode,
		...
		coalesce(to_char(pe.effectivedate, 'YYYYMMdd'), ' ')::char(8) as hiredate,  ---- position 611-618
--		ed.emplstatus,
		case
