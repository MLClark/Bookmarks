/*
This sql generate both the add and term BRMS record for employee benefit via union
...
where pi.identitytype = 'SSN'
  ...
  AND pbe.effectivedate >= elu.lastupdatets
  and pi.personid  in ('3258')

union 

/*
This section generates the termination of an employees coverage. 
This is an employee only record
