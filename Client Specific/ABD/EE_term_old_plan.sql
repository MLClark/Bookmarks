/*
This sql generates the termination of an employees coverage. 
...
,' ' ::char(8) as dob --- dependent only
,'0' ::char(4) as depseqnbr
...
,' ' ::char(1) as filler_17
,' ' ::char(1) as filler_18
,' ' ::char(1) as fsa_er_pp_contrib
,' ' ::char(1) as fsa_ee_pp_contrib
,' ' ::char(1) as mult_annual_sal
,' ' ::char(1) as elec_bene_amt
,' ' ::char(1) as ee_monthly_prem  
