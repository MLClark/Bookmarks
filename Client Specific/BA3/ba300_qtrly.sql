...
, SUBSTRING(individual_key,1,5) as pay_group
, pn.lname 
, pn.fname
...
, sum(pph.state_gross_pay ) as qtr_state_gross_pay
, sum(pph.gross_pay)  as qtr_gross_pay
from DATES  
...
WHERE DATES.prevQTR_begin_dt <= lc.enddate 
  ...
  and SUBSTRING(pip.identity,1,5) in ('BA300')
  and pph.check_date BETWEEN '2017-01-01' and '2017-03-31' 
