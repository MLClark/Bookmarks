...
,pbe.benefitsubclass
,case when pbe.benefitsubclass in ('2Z','26') then 'LE000022'
...
---- tier_code identifies spouse
,case when pbe.benefitsubclass in ('2Z','26') then 'F' end ::char(2) as tier_code
