...
,case when pc.earningscode = 'ExcHrly' and pbe.benefitelection  = 'E' then 'A003'
      when pc.earningscode = 'ExcHrly' and pbe.benefitelection <> 'E' then 'A004'
      when pc.earningscode in ('Regular','RegHrly') and pbe.benefitelection  = 'E' then 'A001' 
      when pc.earningscode in ('Regular','RegHrly') and pbe.benefitelection <> 'E' then 'A002' else 'A004' end ::char(4) as class_id
