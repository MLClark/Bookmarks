...
,cast(bd.hours as dec(18,2)) as TRXHRUNT 
,case when pc.frequencycode = 'H' then cast(pc.compamount as dec(18,2)) 
      when pc.frequencycode = 'A' then cast(pc.compamount / 2080 as dec(18,2)) end as HRLYPYRT    
,cast(bd.amount as dec(18,2)) as PAYRTAMT
