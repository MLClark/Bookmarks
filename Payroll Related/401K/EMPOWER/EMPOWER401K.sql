...
,to_char(ytdcomp.ytdhours,'00000')                                                   AS hours_worked
...
left JOIN (SELECT individual_key
  ...
  ON ppdvb1.individual_key = piP.identity
...
left JOIN (SELECT individual_key
  ...
  ON ppdvb2.individual_key = piP.identity 
-- roth
left JOIN (SELECT individual_key
                 ,sum(etv_amount) as etv_amount
             FROM pspay_payment_detail            
  ...
  ON ppdvb3.individual_key = piP.identity 
-- Roth Catch Up                                
left JOIN (SELECT individual_key
                 ,sum(etv_amount) as etv_amount
             FROM pspay_payment_detail            
  ...
  ON ppdvb4.individual_key = piP.identity 
-- 401KCMAE
left JOIN (SELECT individual_key
                 ,sum(etv_amount) as etv_amount
             FROM pspay_payment_detail            
  ...
  ON ppdvb5.individual_key = piP.identity 
-- loan 1
left JOIN (SELECT individual_key
                 ,sum(etv_amount) as etv_amount
             FROM pspay_payment_detail            
  ...
  ON ppdv65.individual_key = piP.identity 
-- ee total hours 
