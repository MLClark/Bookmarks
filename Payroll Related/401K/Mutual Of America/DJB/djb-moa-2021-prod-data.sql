...
ppd.personid
,psp.periodpaydate
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '4' then etv_amount  else 0 end as e12_amount  -- Exlcuded Earnings
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '1' then etv_amount  else 0 end as vb1_amount  -- 403b/401k deductions
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '2' then etv_amount  else 0 end as vb3_amount  -- Roth deductions  
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '3' then etv_amount  else 0 end as vb5_amount  -- Employer Match
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '6' then etv_amount  else 0 end as vb6_amount  -- Employer Base Contribution
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '1' then etv_amount  else 0 end as loan1_amount  -- Loan 1
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '1' then lookup.value2  else null end as loan1_number  -- Loan 1
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '2' then etv_amount  else 0 end as loan2_amount  -- Loan 2
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '2' then lookup.value2  else null end as loan2_number  -- Loan 2
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '3' then etv_amount  else 0 end as loan3_amount  -- Loan 3
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '3' then lookup.value2  else null end as loan3_number  -- Loan 3
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '4' then etv_amount  else 0 end as loan4_amount  -- Loan 3
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '4' then lookup.value2  else null end as loan4_number  -- Loan 3
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '5' then etv_amount  else 0 end as loan5_amount  -- Loan 3
,case when ppd.etv_id = lookup.etvid and lookup.value1 = '5' and lookup.value2 = '5' then lookup.value2  else null end as loan5_number  -- Loan 3
,ppd.paymentheaderid
...
---------------------------------------------
LEFT JOIN  (select lp.lookupid, key1 as etvid, value1, value2 from edi.lookup lp
