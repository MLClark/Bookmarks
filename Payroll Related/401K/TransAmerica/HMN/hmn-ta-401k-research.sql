...
where pi.identitytype = 'SSN'::bpchar and pi.personid = '63839'
  AND current_timestamp between pi.createts and pi.endts and ppd.etv_id  in  ('VB1','VBU','VB2','V65','VBT','VB5','VB3','VB4')
  group by 1,2,3)
  
  select * from pspay_payment_detail where etv_id = 'VB2' and personid = '63839';
...
select * from pspay_payment_detail where personid = '63839' and etv_id = 'VB2' and check_date >= '2019-04-29';
select * from pspay_payment_header where personid = '63839' and paymentheaderid in ('79691','79692');
...
select * from person_identity where identity = 'HMN00000093191';

select * from person_names where personid = '63839';




select * from pay_schedule_period where date_part('year',periodpaydate)='2019' and date_part('month',periodpaydate)='05';
select * from person_names where lname like 'Gard%';
select * from person_identity where personid = '68398';
select * from pspay_input_transaction where individual_key = 'HMN00000019292';
select * from pspay_input_transaction where primary_key_idd_name in ('DA65','DN65') and effectivedate = '2019-05-01';
select * from edi.edi_last_update;

update edi.edi_last_update set lastupdatets = '2019-04-16 22:59:04' where feedid = 'HMN_401k_Census_File_Export'; --2019/04/16 23:59:06'

select * from person_employment where personid in ('64026');
select distinct
 pi.personid
,'D' ::char(1) as id
...
where pi.identitytype = 'SSN'
  ...
  and psp.periodpaydate =  '2019-03-29' -- '2019-04-15'
  and pi.personid in ('68398')
