...
select distinct
 pi.personid
,ppd.individual_key
,'CONT' ::char(4) as recordType
,'0001' ::char(4) as recordVersionNbr
,'061654' ::char(6) as masterContactNbr
,'PLAN1' ::char(8) as planCode
,'941051349' ::char(12) as sein
,pi.identity ::char(9) as ssn
,to_char(ppd_401k.check_date,'yyyymmdd')::char(8) as paydate
,to_char(pph.period_begin_date,'yyyymmdd')::char(8) as payPerStartDt
,to_char(pph.period_end_date,'yyyymmdd')::char(8) as payPerEndDt
