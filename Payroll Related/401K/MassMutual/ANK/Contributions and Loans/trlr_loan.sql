--- ANK Contribution LNPR Trailer
select distinct
 count(*) AS totalDSrowsByETV
,CASE WHEN PPD.ETV_ID = 'V65' THEN sum(ppd.etv_amount) end as totalLoanAmt
,CASE WHEN PPD.ETV_ID = 'V65' THEN 'LOAN' ELSE 'CONT' END as rectype
,ppd.etv_id
