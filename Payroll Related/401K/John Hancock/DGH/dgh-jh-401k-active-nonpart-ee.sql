select distinct
 pi.personid
,'ACTIVE NON-PARTICIPATING ELIGIBLE EE' ::varchar(40) as qsource
,pe.emplstatus
,pe.effectivedate
,sg.grade
,pu.payunitxid as pay_unit
,lc.locationcode
...
,to_char(?::DATE,'MMDDYYYY')::char(8) as pay_date -- col AZ
...
where pi.identitytype = 'SSN'::bpchar 
  AND current_timestamp between pi.createts and pi.endts and ppd.etv_id  in  ('VB1','VB2','VB3','VB4','VB5','VB6')) x
...
where pi.identitytype = 'SSN'::bpchar 
  AND current_timestamp between pi.createts and pi.endts and ppd.etv_id  in  ('V65','V73','VCI','VCJ')) x
...
where pi.identitytype = 'SSN'
  ...
  (select personid from pspay_payment_detail ppd where ppd.check_date = ?::DATE 
     and ppd.etv_id in ('V65','V73','VCI','VCJ','VB1','VB2','VB3','VB4','VB5','VB6') group by 1)
