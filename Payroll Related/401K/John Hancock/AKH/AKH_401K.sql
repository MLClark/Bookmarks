...
,coalesce(ppdvb1.etv_amount,ppdvb2.etv_amount) as eedef           -- col AY should have the PreTax EE Catchup Amount (per pay)
...
where pi.identitytype = 'SSN'
  ...
  and pe.emplstatus <> 'L'
 -- and ppd.etv_id IN ('VB1','VB2','VB3','VB4','VB5','V25','V65', 'VCQ')  
 -- AND PI.PERSONID IN ('7442','9998')
  and pi.personid = '7352'
 order by 1
