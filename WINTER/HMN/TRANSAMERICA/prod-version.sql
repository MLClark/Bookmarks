...
where paymentheaderid in 
  ...
  ,x.svb1_amount,x.svbu_amount,x.svb2_amount,x.sv65_amount,x.svbt_amount,x.svb5_amount,x.svb3_amount,x.svb4_amount
...
where pi.identitytype = 'SSN'
  ...
  order by personid, ssn, sort_contrib_code