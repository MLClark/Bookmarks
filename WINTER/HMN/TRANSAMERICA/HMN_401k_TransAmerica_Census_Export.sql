...
join edi.edi_last_update elu on elu.feedid = 'HMN_TransAmerica401k_Contribution_Export' 
...
,case when x.etv_id = 'VB1' and x.vb1_amount <  0 then to_char(vb1_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VB1' and x.vb1_amount >= 0 then to_char(vb1_amount* 1,'0000000000009v99') end ::char(16) as svb1_amount
,case when x.etv_id = 'VBU' and x.vbu_amount <  0 then to_char(vbu_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VBU' and x.vbu_amount >= 0 then to_char(vbu_amount* 1,'0000000000009v99') end ::char(16) as svbu_amount
,case when x.etv_id = 'VB2' and x.vb2_amount <  0 then to_char(vb2_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VB2' and x.vb2_amount >= 0 then to_char(vb2_amount* 1,'0000000000009v99') end ::char(16) as svb2_amount
,case when x.etv_id = 'V65' and x.v65_amount <  0 then to_char(v65_amount*-1,'0000000000009v99') 
      when x.etv_id = 'V65' and x.v65_amount >= 0 then to_char(v65_amount* 1,'0000000000009v99') end ::char(16) as sv65_amount
,case when x.etv_id = 'VBT' and x.vbt_amount <  0 then to_char(vbt_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VBT' and x.vbt_amount >= 0 then to_char(vbt_amount* 1,'0000000000009v99') end ::char(16) as svbt_amount
,case when x.etv_id = 'VB5' and x.vb5_amount <  0 then to_char(vb5_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VB5' and x.vb5_amount >= 0 then to_char(vb5_amount* 1,'0000000000009v99') end ::char(16) as svb5_amount
,case when x.etv_id = 'VB3' and x.vb3_amount <  0 then to_char(vb3_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VB3' and x.vb3_amount >= 0 then to_char(vb3_amount* 1,'0000000000009v99') end ::char(16) as svb3_amount
,case when x.etv_id = 'VB4' and x.vb4_amount <  0 then to_char(vb4_amount*-1,'0000000000009v99') 
      when x.etv_id = 'VB4' and x.vb4_amount >= 0 then to_char(vb4_amount* 1,'0000000000009v99') end ::char(16) as svb4_amount
...
where paymentheaderid in 
  ...
  and ppd.etv_id  in  ('VB1','VBU','VB2','V65','VBT','VB5','VB3','VB4')
  group by personid,check_date,etv_id) x
group by  x.personid,x.check_date,x.etv_id
  ,x.vb1_amount,x.vbu_amount,x.vb2_amount,x.v65_amount,x.vbt_amount,x.vb5_amount,x.vb3_amount,x.vb4_amount

  having sum(x.vb1_amount + x.vbu_amount + x.vb2_amount + x.v65_amount + x.vbt_amount + x.vb5_amount + x.vb4_amount + x.vb3_amount) <> 0
  )
  dedamt on dedamt.personid = pi.personid --and dedamt.check_date = psp.periodpaydate
  
  
  -- select * from pay_schedule_period where periodpaydate = '2020-02-28';
...
where pi.identitytype = 'SSN'
  ...
  and psp.periodpaydate = ?::date 
  --and pi.personid = '65370'
    --and pi.identity = '325720913'
    --and pi.identity = '326504755' --vb1,5 and u all have 43.63 in prod
    --and pi.identity = '332808347'  -- missing vbu vb5 amounts in demqa
   -- and pi.identity = '355862997' -- missing vbu vb5 amounts in demqa
