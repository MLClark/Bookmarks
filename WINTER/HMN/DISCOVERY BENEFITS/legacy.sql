...
---- 1-24-2020 update plan_names Transit Account and Parking Account    
...
from pspay_payment_detail ppd where ppd.etv_id  in ('VEJ','VEK','VEH') and date_part('year',check_date) = date_part('year',current_date)
     
  group by 1) fsa on fsa.personid = ppd.personid

where pi.identitytype = 'SSN'
  and current_timestamp between pi.createts and pi.endts
 and pi.identity = '335609480'
 
  --and pi.personid = '63269'
