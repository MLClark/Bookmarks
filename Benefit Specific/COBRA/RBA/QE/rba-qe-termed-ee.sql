...
----- MEDICAL   -----
---------------------  
,case when pbemed.benefitsubclass = '10' and pbemed.benefitplanid = '9'  then 'Regence Buy-Up'
      when pbemed.benefitsubclass = '10' and pbemed.benefitplanid = '15' then 'Regence Base' else ' ' end ::varchar(50) as medical_plan
...
,case when pbemed.benefitsubclass = '10' then to_char(pbemed.effectivedate,'mm/dd/yyyy')else ' ' end ::char(10) as medical_end_date                
---------------------
----- DENTAL    -----     
---------------------
...
,case when pbednt.benefitsubclass = '11' then to_char(pbednt.effectivedate,'mm/dd/yyyy')else ' ' end ::char(10) as dental_end_date       
---------------------
----- VISION    -----
---------------------
...
,case when pbevsn.benefitsubclass = '14' then to_char(pbevsn.effectivedate,'mm/dd/yyyy')else ' ' end ::char(10) as vision_end_date  
---------------------
----- FSA       -----
---------------------
...
,case when pbemfsa.benefitsubclass = '60' then to_char(pbemfsa.effectivedate,'mm/dd/yyyy')else ' ' end ::char(10) as fsa_end_date  
...
(select distinct pdr.personid, pdr.dependentid, rank() over(partition by pdr.personid order by  pdr.dependentid asc) as depid
  ...
  where pdr.dependentrelationship in ('S','D','C','NS','ND','NC')
