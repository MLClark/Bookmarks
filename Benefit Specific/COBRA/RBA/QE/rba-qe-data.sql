...
,case when pbemed.benefitsubclass = '10' and pbemed.benefitplanid = '6' then 'Regence Buy-Up'
      when pbemed.benefitsubclass = '10' and pbemed.benefitplanid = '9' then 'Regence Base' else ' ' end ::varchar(50) as medical_plan
