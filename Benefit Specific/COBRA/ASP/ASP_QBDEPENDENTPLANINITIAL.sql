...
,case when bpd.benefitplandesc in ('Guardian Dental DHMO') then 'Dental- Guardian DHMO'
      when bpd.benefitplandesc in ('Guardian Dental PPO') then 'Dental- Guardian PPO'
