...
join ((select * from person_bene_election 
       where benefitsubclass in ('10','11','12','14','1H','1V') and date_part('year',eventdate)='2018'and benefitelection = 'E' and selectedoption = 'Y' and eventdate >= '2018-10-01' and personid not in 
(select distinct personid from person_bene_election where benefitsubclass in ('10','11','12','14','1H','1V') and date_part('year',eventdate)=date_part('year',current_date) and benefitelection = 'E' and selectedoption = 'Y' and effectivedate <= '2018-10-01'))) pbe
  on pbe.personid = pe.personid and pbe.benefitcoverageid = '1' 
...
,'NEW ENROLLMENT SP' ::varchar(40) as qsource
,'1' ::char(1) as change_type
,pn.fname ::varchar(30) as fname
,pn.lname ::varchar(30) as lname
,pn.mname ::char(1) as mname
