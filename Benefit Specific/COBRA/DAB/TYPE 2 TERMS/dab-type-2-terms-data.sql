...
join person_benefit_action pba
 ...
 and pba.eventeffectivedate >= '2018-01-01'
 and pba.personid in 
(select personid from person_bene_election where benefitsubclass in  ('10','11','12','14','1H','1V')and benefitelection = 'E' and selectedoption = 'Y'and effectivedate < enddate and current_timestamp between createts and endts)
...
,'TERMED SP' ::varchar(40) as qsource
...
JOIN person_bene_election pbe 
 ...
 AND current_timestamp between pbe.createts AND pbe.endts
  -- to be qualified for cobra the emp must have participated in employer's health care plan  
 and pbe.personid in (select personid from person_bene_election where benefitsubclass in  ('10','11','12','14','1H','1V')and benefitcoverageid > '1'
...
,'TERMED DEP' ::varchar(40) as qsource
,'2' ::char(1) as change_type
,pn.fname ::varchar(30) as fname
,pn.lname ::varchar(30) as lname
,pn.mname ::char(1) as mname
