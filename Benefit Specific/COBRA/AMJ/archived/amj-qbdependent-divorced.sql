...
SELECT distinct  
 pie.personid
,pdr.dependentid
,'DIVORCED' ::VARCHAR(30) AS QSOURCE
...
WHERE pie.identitytype = 'SSN' 
  ...
  and (pm.effectivedate >= elu.lastupdatets::DATE 
   or (pm.createts > elu.lastupdatets and pm.effectivedate < coalesce(elu.lastupdatets, '2017-01-01')) ) 
