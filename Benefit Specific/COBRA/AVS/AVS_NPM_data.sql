...
,'"Two Go LLC, dba Monterey Bay Chrysler Jeep Dodge"' :: varchar(100) as client_name
,'"Two Go LLC, dba Monterey Bay Chrysler Jeep Dodge"' :: varchar(100) as client_division_name
