...
,case when pbe.benefitelection = 'T' and pbe.benefitsubclass in ('11','16') then to_char(pbe.effectivedate,'MMDDYYYY') else '        ' end ::char(8) as dent_cov_start
...
left join person_bene_election pbe
 ...
 and pbe.benefitsubclass in ('11','16')
