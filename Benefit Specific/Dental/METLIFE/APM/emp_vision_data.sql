...
,case when pbe.benefitelection = 'T' and pbe.benefitsubclass in ('14','17') then to_char(pbe.enddate,'MMDDYYYY') else ' ' end ::char(8) as vsn_cov_end
...
,case when pbe.benefitsubclass in ('14') and pbe.benefitelection = 'E' then 'A' 
      when pbe.benefitsubclass in ('14') and pbe.benefitelection = 'R' then 'R'
