...
,case when pbe.benefitsubclass in ('11') and pbe.benefitelection = 'T' then to_char(pbe.effectivedate,'MMDDYYYY') else '        ' end ::char(8) as dent_cov_end
...
,case when pbe.benefitsubclass in ('11') and pbe.benefitelection = 'E' then 'A' 
      when pbe.benefitsubclass in ('11') and pbe.benefitelection = 'R' then 'R' else 'A' end ::char(1) as dent_status
