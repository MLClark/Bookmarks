select distinct
 ...
 pi.personid
,'24 ACTIVE EE' ::varchar(30) as qsource 
...
,'S' ::char(8) as payroll_freq
,to_char(pbe.effectivedate,'mm/dd/yyyy')::char(10) as effective_date
,'EE' ::char(2) as ee_contrib_source
,null as er_contrib
,case when rankmfsa.coverageamount = 2500.00 then cast(pbemfsa.monthlyamount/2-.01 as dec(18,2)) else cast(pbemfsa.monthlyamount/2 as dec(18,2))end as mfsa_ppay_contrib
...
LEFT join edi.edi_last_update elu on elu.feedid = 'RBA_Sound_Admin_FSA_Export'
...
,cast(rankdfsa.coverageamount as dec(18,2)) as dfsa_annual_election
,cast(pbedfsa.monthlyamount/2 as dec(18,2)) as dfsa_ppay_contrib
,to_char(pbe.effectivedate,'mm/dd/yyyy')::char(10) as term_date
