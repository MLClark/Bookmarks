select distinct
 ...
 pi.personid
,'termed ees' ::varchar(40) as qsource
...
,to_char(pe.effectivedate,'mm/dd/yyyy') ::char(10) as termdate
...
left join (select personid, scheduledhours, MAX(effectivedate) AS effectivedate, MAX(enddate) AS enddate,      
             ...
             from pers_pos pp group by personid,scheduledhours) pp on pp.personid = pe.personid and pp.rank = 1 
