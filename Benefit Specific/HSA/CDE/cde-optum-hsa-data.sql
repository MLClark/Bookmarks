...
,case when bpd.benefitplancode = 'HSAEE' then 'I' 
      when bpd.benefitplancode = 'HSAFAM'then 'F' 
     -- when bpd.benefitplancode = 'HSACU' and bpd.benefitplancode = 'HSAEE' then 'I' 
     -- when bpd.benefitplancode = 'HSACU' and bpd.benefitplancode = 'HSAFAM'then 'F' 
      else '' 
 end ::char(1) as cov_type
...
,case when pae1.postalcode isnull then ''
	  else '0000' 
 end ::char(4) as mailing_zip4
...
join person_bene_election pbe
 ...
 --and pbe.benefitsubclass in ('6Z','6Y')
...
where pi.identitytype = 'SSN' 
	  ...
	  and pe.emplstatus <> 'T'
	  AND ((pbe1.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pbe1.createts > elu.lastupdatets)
        or (pbe.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pbe.createts > elu.lastupdatets)
        or (pe.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pe.createts > elu.lastupdatets)
	    or (pne.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pne.createts > elu.lastupdatets)
        or (pae.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pae.createts > elu.lastupdatets)
		or (pae1.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pae1.createts > elu.lastupdatets)
        or (pve.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pve.createts > elu.lastupdatets)
	    or (ppch.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND ppch.createts > elu.lastupdatets)
        or (ppcw.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND ppcw.createts > elu.lastupdatets)
        or (ppcb.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND ppcb.createts > elu.lastupdatets)
	    or (ppcm.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND ppcm.createts > elu.lastupdatets)
        or (pncw.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pncw.createts > elu.lastupdatets)
        or (pnch.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pnch.createts > elu.lastupdatets)
        or (pnco.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND pnco.createts > elu.lastupdatets)
        or (bpd.effectivedate >= coalesce(elu.lastupdatets,'2018-01-01') AND bpd.createts > elu.lastupdatets))
