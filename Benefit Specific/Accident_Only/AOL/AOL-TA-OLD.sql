...
,'0' as dependentid
,'1' ::char(1) as sortseq
,'ACTIVE EE W ACD' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = '1AC' then 'G000035653_'|| pi.identity ||'_AC' end ::varchar(25) as CORRELATION_GUID
...
,' ' ::char(1) as filler04
,case when pbe.benefitsubclass = '1AC' then 'AV' end ::char(10) as PRODUCT_CODE
...
,'2' ::char(1) as sortseq
,'ACTIVE EE DEP SP W ACD' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = '1AC' then 'G000035653_'|| pi.identity ||'_AC' end ::varchar(25) as CORRELATION_GUID
,replace(pidep.identity,'-','') ::char(9) as PERSON_SSN
,pie.identity ::char(9) as EMPLOYEE_OR_MEMBER_ID
,case when pdr.dependentrelationship in ('SP','DP')         then 'SPOUSE'
      when pdr.dependentrelationship in ('D','S','C')  then 'DEPENDENT'
...
where pi.identitytype = 'SSN'
  ...
  AND bcd.benefitcoveragedesc <> 'Employee + Children'
 -- and pe.personid = '1927'
...
,pdr.dependentid as dependentid
,'3' ::char(1) as sortseq
,'ACTIVE EE CHILD DEP W ACD' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = '1AC' then 'G000035653_'|| pi.identity ||'_AC' end ::varchar(25) as CORRELATION_GUID
,replace(pidep.identity,'-','') ::char(9) as PERSON_SSN
...
where pi.identitytype = 'SSN'
  ...
  and pe.emplstatus = 'A'
  and maxcomp.benefitcoverageid <> '1'  
  AND bcd.benefitcoveragedesc <> 'Employee + Spouse'
 -- and pe.personid = '1927'  
...
left join (select personid, compamount, frequencycode, max(effectivedate) as effectivedate, 
...
left join (select personid, scheduledhours,max(effectivedate) as effectivedate, 
RANK() OVER (PARTITION BY personid ORDER BY MAX(effectivedate) DESC) AS RANK
from pers_pos where current_timestamp between createts and endts
group by 1,2) pp on pp.personid = pe.personid and pp.rank = 1
...
left join (select locationid, locationdescription,max(effectivedate) as effectivedate, 
RANK() OVER (PARTITION BY locationid ORDER BY MAX(effectivedate) DESC) AS RANK
from location_codes where current_timestamp between createts and endts
group by 1,2) lc on lc.locationid = pl.locationid and pp.rank = 1 
...
,pdr.dependentid as dependentid
,'2' ::char(1) as sortseq
,'TERMED EE DEP W ACD' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = '1AC' then 'G000035653_'|| pi.identity ||'_AC' end ::varchar(25) as CORRELATION_GUID
,replace(pidep.identity,'-','') ::char(9) as PERSON_SSN
...
,'ACTIVE EE W CI' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
...
,pdr.dependentid as dependentid
,'3' ::char(1) as sortseq
,'ACTIVE EE DEP CHILDREN W CI' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = 'CIV' then 'G000035653_'|| pi.identity ||'_CE' end ::varchar(25) as CORRELATION_GUID
,replace(pidep.identity,'-','') ::char(9) as PERSON_SSN
...
,'TERMED EE W CI' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = 'CIV' then 'G000035653_'|| pi.identity ||'_CE' end ::varchar(25) as CORRELATION_GUID
,pi.identity ::char(9) as PERSON_SSN
...
,pdr.dependentid as dependentid
,'2' ::char(1) as sortseq
,'TERMED EE DEP SPOUSE W CI' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = 'CIV' then 'G000035653_'|| pi.identity ||'_CE' end ::varchar(25) as CORRELATION_GUID
,replace(pidep.identity,'-','') ::char(9) as PERSON_SSN
...
,pdr.dependentid as dependentid
,'3' ::char(1) as sortseq
,'TERMED EE DEP CHILDREN W CI' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,case when pbe.benefitsubclass = 'CIV' then 'G000035653_'|| pi.identity ||'_CE' end ::varchar(25) as CORRELATION_GUID
,replace(pidep.identity,'-','') ::char(9) as PERSON_SSN
...
order by personid,sortseq,dependentid