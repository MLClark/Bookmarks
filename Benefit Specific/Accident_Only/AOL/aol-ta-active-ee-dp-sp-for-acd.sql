...
,'0' as dependentid
,'1' ::char(1) as sortseq
,'ACTIVE EE W AC' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,'G000035653_'|| pi.identity ||'_AC' as CORRELATION_GUID
...
,coalesce(pbe.coverageamount,0.00) as BENEFIT_FACE_AMOUNT
, ' ' ::char(10) as filler05
, ' ' ::char(1) as filler06
, ' ' ::char(1) as filler07
...
,ppdac.etv_amount  ::char(5) as TOTAL_PREMIUM
,ppdac.etv_amount  ::char(5) as EE_PAID_PREMIUM
...
left join pspay_payment_detail ppdac
  on ppdac.etv_id in ('V40')
 and ppdac.personid = pi.personid
 and ppdac.check_date = psp.periodpaydate
 and ppdac.paymentheaderid = pph.paymentheaderid

where pi.identitytype = 'SSN'
  and current_timestamp between pi.createts and pi.endts 
  and pe.emplstatus = 'A'
  and ppdac.etv_amount is not null
...
,'2' ::char(1) as sortseq
,'ACTIVE EE SP W AC' ::varchar(30) as qsource
,'WIJ4FD6L' ::char(8) as EDI_ACCOUNT_ID 
,pi.identity ::char(9) as EMPLOYEE_SSN 
,'G000035653_'|| pi.identity ||'_AC' as CORRELATION_GUID
