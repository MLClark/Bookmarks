...
--HS20180605 Start: Following added to only pick deps who are enrolled in plans

 JOIN dependent_enrollment de on de.dependentid = pdr.dependentid
 AND de.selectedoption = 'Y' 
 and de.benefitsubclass = pbeT.benefitsubclass
