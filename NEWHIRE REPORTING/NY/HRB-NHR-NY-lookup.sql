...
insert into edi.lookup (lookupid,value1) select lkups.lookupid,'26-1841386' from edi.lookup_schema lkups where lookupname = 'NY FEIN';
insert into edi.lookup (lookupid,key1,value1,value2,value3,value4,value5,value6) select lkups.lookupid,'26-1841386'
,'1991 Second Avenue','New York','NY','10029','US','Dream Charter School' from edi.lookup_schema lkups where lookupname = 'NY FEIN Address';

insert into edi.lookup (lookupid,value1) select lkups.lookupid,'13-4025290' from edi.lookup_schema lkups where lookupname = 'NY FEIN';
insert into edi.lookup (lookupid,key1,value1,value2,value3,value4,value5,value6) select lkups.lookupid,'13-4025290'
,'1991 Second Avenue','New York','NY','10029','US','Harlem RBI Incorporated dba DREAM' from edi.lookup_schema lkups where lookupname = 'NY FEIN Address';
