...
,pea_e01.current_earn_hours as e01_hours
,pea_e01.current_earn_amount as e01_amount
,pea_e15.current_earn_hours as e15_hours
,pea_e15.current_earn_amount as e15_amount
,pea_e17.current_earn_hours as e17_hours
,pea_e17.current_earn_amount as e17_amount
...
5=Additional amount
*/
,bd.etv_id ::char(6) as UPRTRXCD --- UPR transaction code (Pay code, Deduction Code or Benefit Code)
...
*/
       ...
       ,CASE
            ...
            CASE
                ...
                END
            END
        END ::char(21) AS HRLYPYRT -------Hourly pay rate
...
,dpd.positiontitle as JOBTITLE -----Job title/position code; if empty, pulls from UPR00100
...
,'??' ::char(21) as SHFTPREM -----Shift premium

,'??' ::char(21) as RequesterTrx
/*
...
join pspay_earning_accumulators pea_e01
  on pea_e01.individual_key = pip.identity
 and pea_e01.etv_id = 'E01' --Regular

join pspay_earning_accumulators pea_e02
  on pea_e02.individual_key = pip.identity
 and pea_e02.etv_id = 'E02' --Overtime 
 
join pspay_earning_accumulators pea_e03
  on pea_e03.individual_key = pip.identity
 and pea_e03.etv_id = 'E03' --DblTime 
 
join pspay_earning_accumulators pea_e04
  on pea_e04.individual_key = pip.identity
 and pea_e04.etv_id = 'E04' --Straight 
 
join pspay_earning_accumulators pea_e05
  on pea_e05.individual_key = pip.identity
 and pea_e05.etv_id = 'E05' --Shift2  

join pspay_earning_accumulators pea_e06
  on pea_e06.individual_key = pip.identity
 and pea_e06.etv_id = 'E06' --Shift   
 
join pspay_earning_accumulators pea_e17
  on pea_e17.individual_key = pip.identity
 and pea_e17.etv_id = 'E17' 
  

join pspay_earning_accumulators pea_e15
  on pea_e17.individual_key = pip.identity
 and pea_e17.etv_id = 'E15' 
