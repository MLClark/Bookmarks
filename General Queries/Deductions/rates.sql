...
JOIN person_payroll pp ON pp.personid=pc.personid
	and current_date between pp.effectivedate and pp.enddate
	and current_timestamp between pp.createts and pp.endts
	and pp.payunitrelationship = 'M'
JOIN pay_unit pu ON pu.payunitid=pp.payunitid
JOIN frequency_codes unitfc ON unitfc.frequencycode=pu.frequencycode
...
and (pc.earningscode like '%Reg%' or pc.earningscode like 'Exc%')
and pc.enddate > now()
